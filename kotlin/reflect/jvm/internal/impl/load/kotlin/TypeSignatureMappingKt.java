...
{
  private static final <T> T boxTypeIfNeeded(JvmTypeFactory<T> paramJvmTypeFactory, T paramT, boolean paramBoolean)
  {
  ...
  public static final String computeInternalName(ClassDescriptor paramClassDescriptor, TypeMappingConfiguration<?> paramTypeMappingConfiguration)
  {
    ...
    if ((localDeclarationDescriptor instanceof PackageFragmentDescriptor))
    {
      ...
      else
      {
        ...
        paramClassDescriptor = paramClassDescriptor.toString();
      }
  ...
  public static final boolean hasVoidReturnType(CallableDescriptor paramCallableDescriptor)
  {
    Intrinsics.checkParameterIsNotNull(paramCallableDescriptor, "descriptor");
    boolean bool1 = paramCallableDescriptor instanceof ConstructorDescriptor;
    boolean bool2 = true;
    if (bool1) {
      return true;
    }
  ...
  public static final <T> T mapBuiltInType(TypeSystemCommonBackendContext paramTypeSystemCommonBackendContext, KotlinTypeMarker paramKotlinTypeMarker, JvmTypeFactory<T> paramJvmTypeFactory, TypeMappingMode paramTypeMappingMode)
  {
    ...
    if (localPrimitiveType != null)
    {
      ...
      return boxTypeIfNeeded(paramJvmTypeFactory, paramTypeMappingMode, bool2);
    }
    ...
    if (paramTypeSystemCommonBackendContext.isUnderKotlinPackage(localTypeConstructorMarker))
    {
      ...
      if (paramTypeSystemCommonBackendContext != null)
      {
        if (!paramTypeMappingMode.getKotlinCollectionsToJavaCollections())
        {
          ...
          do
          {
            while (!paramKotlinTypeMarker.hasNext())
            {
              i = 0;
              break;
  ...
  public static final <T> T mapType(KotlinType paramKotlinType, JvmTypeFactory<T> paramJvmTypeFactory, TypeMappingMode paramTypeMappingMode, TypeMappingConfiguration<? extends T> paramTypeMappingConfiguration, JvmDescriptorTypeWriter<T> paramJvmDescriptorTypeWriter, Function3<? super KotlinType, ? super T, ? super TypeMappingMode, Unit> paramFunction3)
  {
