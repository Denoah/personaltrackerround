  ...
  implements FuseToFlowable<Boolean>
{
  ...
  {
    this.source.subscribe(new AnySubscriber(paramSingleObserver, this.predicate));
  }
    ...
    implements FlowableSubscriber<T>, Disposable
  {
    ...
    AnySubscriber(SingleObserver<? super Boolean> paramSingleObserver, Predicate<? super T> paramPredicate)
    {
