  ...
  extends Service
{
    ...
    implements MediaBrowserServiceCompat.MediaBrowserServiceImpl, MediaBrowserServiceCompatApi21.ServiceCompatProxy
  {
    ...
    public void onCreate()
    {
      Object localObject = MediaBrowserServiceCompatApi21.createService(MediaBrowserServiceCompat.this, this);
      this.mServiceObj = localObject;
      MediaBrowserServiceCompatApi21.onCreate(localObject);
    }
    ...
    public MediaBrowserServiceCompatApi21.BrowserRoot onGetRoot(String paramString, int paramInt, Bundle paramBundle)
    {
      ...
      if ((paramBundle != null) && (paramBundle.getInt("extra_client_version", 0) != 0))
      {
        ...
        {
          localObject2 = MediaBrowserServiceCompat.this.mSession.getExtraBinder();
          if (localObject2 == null) {
            localObject2 = null;
          } else {
            localObject2 = ((IMediaSession)localObject2).asBinder();
          }
      ...
      Object localObject1 = MediaBrowserServiceCompat.this;
      ((MediaBrowserServiceCompat)localObject1).mCurConnection = new MediaBrowserServiceCompat.ConnectionRecord((MediaBrowserServiceCompat)localObject1, paramString, -1, paramInt, paramBundle, null);
