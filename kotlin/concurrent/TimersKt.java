...
public final class TimersKt
{
  ...
  {
    if (paramString == null) {
      paramString = new Timer(paramBoolean);
    } else {
      paramString = new Timer(paramString, paramBoolean);
    }
    return paramString;
  }
