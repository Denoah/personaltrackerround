...
class TwilightCalculator
{
  ...
  public void calculateTwilight(long paramLong, double paramDouble1, double paramDouble2)
  {
    ...
    double d1 = f2;
    double d2 = Math.sin(d1) * 0.03341960161924362D + d1 + Math.sin(2.0F * f2) * 3.4906598739326E-4D + Math.sin(f2 * 3.0F) * 5.236000106378924E-6D + 1.796593063D + 3.141592653589793D;
