  ...
  implements Continuation<T>
{
  ...
  public final Object getResult()
  {
    ...
    Object localObject2 = UNDECIDED;
    Object localObject3 = localObject1;
    if (localObject1 == localObject2)
    {
      if (RESULT.compareAndSet(this, localObject2, IntrinsicsKt.getCOROUTINE_SUSPENDED())) {
        return IntrinsicsKt.getCOROUTINE_SUSPENDED();
      }
      localObject3 = this.result;
    }
    if (localObject3 == RESUMED) {
      return IntrinsicsKt.getCOROUTINE_SUSPENDED();
    }
    if (!(localObject3 instanceof Fail)) {
      return localObject3;
    }
    throw ((Fail)localObject3).getException();
  }
  ...
  @Metadata(bv={1, 0, 3}, d1={"\000\022\n\002\030\002\n\002\020\000\n\000\n\002\020\003\n\002\b\004\b\002\030\0002\0020\001B\r\022\006\020\002\032\0020\003?\006\002\020\004R\021\020\002\032\0020\003?\006\b\n\000\032\004\b\005\020\006?\006\007"}, d2={"Lkotlin/coroutines/experimental/SafeContinuation$Fail;", "", "exception", "", "(Ljava/lang/Throwable;)V", "getException", "()Ljava/lang/Throwable;", "kotlin-stdlib-coroutines"}, k=1, mv={1, 1, 16})
