        ...
        synchronized (this.this$0)
        {
          ...
          try
          {
            ...
            if (l == -1L)
            {
              ...
              synchronized (this.this$0)
              {
                ...
                ((TypeCastException)???).<init>("null cannot be cast to non-null type java.lang.Object");
                throw ((Throwable)???);
              }
            }
            ...
            synchronized (this.this$0)
            {
              ...
              synchronized (this.this$0)
              {
                ...
                ((TypeCastException)localObject3).<init>("null cannot be cast to non-null type java.lang.Object");
          ...
          finally
          {
            synchronized (this.this$0)
            {
              ...
              {
                localTypeCastException = new kotlin/TypeCastException;
                localTypeCastException.<init>("null cannot be cast to non-null type java.lang.Object");
                throw localTypeCastException;
              }
