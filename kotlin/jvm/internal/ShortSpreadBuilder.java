  ...
  extends PrimitiveSpreadBuilder<short[]>
{
  ...
  public final void add(short paramShort)
  {
    ...
    int i = getPosition();
    setPosition(i + 1);
    arrayOfShort[i] = ((short)paramShort);
  }
