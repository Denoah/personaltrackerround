...
public final class CertificatePinner
{
  ...
  public final void check$okhttp(String paramString, Function0<? extends List<? extends X509Certificate>> paramFunction0)
  {
    ...
    while (((Iterator)localObject1).hasNext())
    {
      paramString = (Pin)((Iterator)localObject1).next();
      paramFunction0.append("\n    ");
      paramFunction0.append(paramString);
    }
  ...
  public boolean equals(Object paramObject)
  {
    if ((paramObject instanceof CertificatePinner))
    {
      ...
      if ((Intrinsics.areEqual(paramObject.pins, this.pins)) && (Intrinsics.areEqual(paramObject.certificateChainCleaner, this.certificateChainCleaner))) {
        return true;
      }
    }
    boolean bool = false;
      ...
      if (i != 0)
      {
        ...
        if (str != null)
        {
          if (StringsKt.startsWith$default(paramString2, "sha1/", false, 2, null))
          {
            ...
            paramString1 = new CertificatePinner.Pin(str, "sha1/", paramString1);
          }
          else
          {
            ...
            paramString1 = new CertificatePinner.Pin(str, "sha256/", paramString1);
          }
          return paramString1;
          label224:
  ...
  @Metadata(bv={1, 0, 3}, d1={"\000*\n\002\030\002\n\002\020\000\n\000\n\002\020\016\n\002\b\002\n\002\030\002\n\002\b\n\n\002\020\013\n\002\b\002\n\002\020\b\n\002\b\004\b?\b\030\0002\0020\001B\035\022\006\020\002\032\0020\003\022\006\020\004\032\0020\003\022\006\020\005\032\0020\006?\006\002\020\007J\t\020\f\032\0020\003H?\003J\t\020\r\032\0020\003H?\003J\t\020\016\032\0020\006H?\003J'\020\017\032\0020\0002\b\b\002\020\002\032\0020\0032\b\b\002\020\004\032\0020\0032\b\b\002\020\005\032\0020\006H?\001J\023\020\020\032\0020\0212\b\020\022\032\004\030\0010\001H?\003J\t\020\023\032\0020\024H?\001J\016\020\025\032\0020\0212\006\020\026\032\0020\003J\b\020\027\032\0020\003H\026R\021\020\005\032\0020\006?\006\b\n\000\032\004\b\b\020\tR\021\020\004\032\0020\003?\006\b\n\000\032\004\b\n\020\013R\016\020\002\032\0020\003X?\004?\006\002\n\000?\006\030"}, d2={"Lokhttp3/CertificatePinner$Pin;", "", "pattern", "", "hashAlgorithm", "hash", "Lokio/ByteString;", "(Ljava/lang/String;Ljava/lang/String;Lokio/ByteString;)V", "getHash", "()Lokio/ByteString;", "getHashAlgorithm", "()Ljava/lang/String;", "component1", "component2", "component3", "copy", "equals", "", "other", "hashCode", "", "matches", "hostname", "toString", "okhttp"}, k=1, mv={1, 1, 16})
  public static final class Pin
  {
    ...
    public boolean equals(Object paramObject)
    {
      if (this != paramObject) {
        if ((paramObject instanceof Pin))
        {
          ...
          if ((Intrinsics.areEqual(this.pattern, paramObject.pattern)) && (Intrinsics.areEqual(this.hashAlgorithm, paramObject.hashAlgorithm)) && (Intrinsics.areEqual(this.hash, paramObject.hash))) {}
        }
        else
        {
          return false;
    ...
    public final boolean matches(String paramString)
    {
      ...
      for (;;)
      {
        ...
        bool2 = bool1;
        if (!StringsKt.regionMatches$default(paramString, paramString.length() - j, this.pattern, 1, j, false, 16, null)) {
          break label199;
        }
        bool2 = bool1;
        if (StringsKt.lastIndexOf$default((CharSequence)paramString, '.', i - j - 1, false, 4, null) != -1) {
          break label199;
        }
      }
      boolean bool2 = Intrinsics.areEqual(paramString, this.pattern);
      label199:
      return bool2;
    }
