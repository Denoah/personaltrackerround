  ...
  implements Closeable
{
    ...
    throws IOException
  {
    if (paramInt3 != 0)
    {
      ...
      if (j == 0)
      {
        ...
        paramInt1 = Companion.lengthWithoutPadding(paramInt1, paramInt2, j);
    ...
    throws IOException
  {
    if (paramInt1 == 8)
    {
      if (paramInt3 == 0)
      {
        ...
        paramHandler.ping(bool, paramInt3, paramInt1);
        return;
      }
    ...
    throws IOException
  {
    ...
    localStringBuilder.append("Expected a connection header but was ");
    localStringBuilder.append(paramHandler.utf8());
