...
public final class MediaType
{
  ...
  {
    Charset localCharset1 = paramCharset;
    try
    {
      if (this.charset != null) {
        localCharset1 = Charset.forName(this.charset);
      }
  ...
  public static final class Companion
  {
    ...
    public final MediaType get(String paramString)
    {
      ...
      Object localObject1 = MediaType.access$getTYPE_SUBTYPE$cp();
      Object localObject2 = (CharSequence)paramString;
      Object localObject3 = ((Pattern)localObject1).matcher((CharSequence)localObject2);
      if (((Matcher)localObject3).lookingAt())
      {
        localObject1 = ((Matcher)localObject3).group(1);
        Intrinsics.checkExpressionValueIsNotNull(localObject1, "typeSubtype.group(1)");
        Object localObject4 = Locale.US;
        Intrinsics.checkExpressionValueIsNotNull(localObject4, "Locale.US");
        if (localObject1 != null)
        {
          localObject4 = ((String)localObject1).toLowerCase((Locale)localObject4);
          Intrinsics.checkExpressionValueIsNotNull(localObject4, "(this as java.lang.String).toLowerCase(locale)");
          String str = ((Matcher)localObject3).group(2);
          Intrinsics.checkExpressionValueIsNotNull(str, "typeSubtype.group(2)");
          localObject1 = Locale.US;
          Intrinsics.checkExpressionValueIsNotNull(localObject1, "Locale.US");
          if (str != null)
          {
            str = str.toLowerCase((Locale)localObject1);
            Intrinsics.checkExpressionValueIsNotNull(str, "(this as java.lang.String).toLowerCase(locale)");
            localObject1 = (String)null;
            Matcher localMatcher = MediaType.access$getPARAMETER$cp().matcher((CharSequence)localObject2);
            ...
            while (i < paramString.length())
            {
              ...
              if (localMatcher.lookingAt())
              {
                ...
                if ((localObject2 != null) && (StringsKt.equals((String)localObject2, "charset", true)))
                {
                  ...
                  if (localObject3 == null)
                  {
                    ...
                    Intrinsics.checkExpressionValueIsNotNull(localObject2, "parameter.group(3)");
                  }
                  else
                  {
                    ...
                    if (StringsKt.startsWith$default((String)localObject3, "'", false, 2, null))
                    {
                      ...
                      if (StringsKt.endsWith$default((String)localObject3, "'", false, 2, null))
                      {
                        ...
                        {
                          localObject2 = ((String)localObject3).substring(1, ((String)localObject3).length() - 1);
                          Intrinsics.checkExpressionValueIsNotNull(localObject2, "(this as java.lang.Strin…ing(startIndex, endIndex)");
                        }
                      }
                    }
                  }
                  if ((localObject1 == null) || (StringsKt.equals((String)localObject2, (String)localObject1, true))) {
                    i = 1;
                  }
                  if (i != 0)
                  {
              ...
              else
              {
                ...
                ((StringBuilder)localObject2).append("Parameter is not formatted correctly: \"");
            ...
            return new MediaType(paramString, (String)localObject4, str, (String)localObject1, null);
          }
      ...
      localObject2 = new StringBuilder();
      ((StringBuilder)localObject2).append("No subtype found for: \"");
      ((StringBuilder)localObject2).append(paramString);
      ((StringBuilder)localObject2).append('"');
      throw ((Throwable)new IllegalArgumentException(((StringBuilder)localObject2).toString().toString()));
    }
