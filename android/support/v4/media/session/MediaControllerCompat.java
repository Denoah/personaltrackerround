...
public final class MediaControllerCompat
{
  ...
  public MediaControllerCompat(Context paramContext, MediaSessionCompat paramMediaSessionCompat)
  {
    if (paramMediaSessionCompat != null)
    {
      ...
      try
      {
        if (Build.VERSION.SDK_INT >= 24)
        {
          MediaControllerImplApi24 localMediaControllerImplApi24 = new android/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi24;
          localMediaControllerImplApi24.<init>(paramContext, this.mToken);
          paramContext = localMediaControllerImplApi24;
        }
        for (;;)
        {
          break;
  ...
  public static MediaControllerCompat getMediaController(Activity paramActivity)
  {
    ...
    if (bool)
    {
      MediaControllerExtraData localMediaControllerExtraData = (MediaControllerExtraData)((ComponentActivity)paramActivity).getExtraData(MediaControllerExtraData.class);
  ...
  static void validateCustomAction(String paramString, Bundle paramBundle)
  {
    ...
    if (((i != 0) && (i != 1)) || ((paramBundle != null) && (paramBundle.containsKey("android.support.v4.media.session.ARGUMENT_MEDIA_ATTRIBUTE")))) {
      return;
    }
    ...
    implements MediaControllerCompat.MediaControllerImpl
  {
      ...
      throws RemoteException
    {
      ...
      this.mControllerObj = paramContext;
