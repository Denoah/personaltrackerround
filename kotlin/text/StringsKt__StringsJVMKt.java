  ...
  extends StringsKt__StringNumberConversionsKt
{
  ...
  public static final byte[] encodeToByteArray(String paramString, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    Object localObject = Charsets.UTF_8.newEncoder().onMalformedInput(CodingErrorAction.REPORT).onUnmappableCharacter(CodingErrorAction.REPORT).encode(CharBuffer.wrap((CharSequence)paramString, paramInt1, paramInt2));
  ...
  public static final String replaceFirst(String paramString, char paramChar1, char paramChar2, boolean paramBoolean)
  {
    ...
    if (i >= 0) {
      paramString = StringsKt.replaceRange(localCharSequence, i, i + 1, (CharSequence)String.valueOf(paramChar2)).toString();
    }
    return paramString;
  }
  ...
  public static final String replaceFirst(String paramString1, String paramString2, String paramString3, boolean paramBoolean)
  {
    ...
    if (i >= 0) {
      paramString1 = StringsKt.replaceRange(localCharSequence, i, paramString2.length() + i, (CharSequence)paramString3).toString();
    }
    return paramString1;
  }
