...
@Metadata(bv={1, 0, 3}, d1={"\000:\n\000\n\002\020\002\n\000\n\002\030\002\n\002\b\004\n\002\030\002\n\002\b\003\n\002\030\002\n\002\030\002\n\000\n\002\020\b\n\002\b\017\n\002\030\002\n\002\b\007\n\002\030\002\n\002\b\002\032\"\020\000\032\0020\0012\006\020\002\032\0020\0032\006\020\004\032\0020\003H\001?\001\000?\006\004\b\005\020\006\032\"\020\007\032\0020\0012\006\020\002\032\0020\b2\006\020\004\032\0020\bH\001?\001\000?\006\004\b\t\020\n\032\034\020\013\032\0020\f*\0020\r2\006\020\016\032\0020\017H\007?\001\000?\006\002\020\020\032\036\020\013\032\0020\f*\0020\r2\006\020\021\032\0020\fH\007?\001\000?\006\004\b\022\020\023\0322\020\013\032\0020\f*\0020\r2\006\020\021\032\0020\f2\b\b\002\020\024\032\0020\0172\b\b\002\020\025\032\0020\017H\007?\001\000?\006\004\b\026\020\027\032\024\020\030\032\0020\003*\0020\rH\007?\001\000?\006\002\020\031\032\036\020\030\032\0020\003*\0020\r2\006\020\004\032\0020\003H\007?\001\000?\006\004\b\032\020\033\032&\020\030\032\0020\003*\0020\r2\006\020\002\032\0020\0032\006\020\004\032\0020\003H\007?\001\000?\006\004\b\034\020\035\032\034\020\030\032\0020\003*\0020\r2\006\020\036\032\0020\037H\007?\001\000?\006\002\020 \032\024\020!\032\0020\b*\0020\rH\007?\001\000?\006\002\020\"\032\036\020!\032\0020\b*\0020\r2\006\020\004\032\0020\bH\007?\001\000?\006\004\b#\020$\032&\020!\032\0020\b*\0020\r2\006\020\002\032\0020\b2\006\020\004\032\0020\bH\007?\001\000?\006\004\b%\020&\032\034\020!\032\0020\b*\0020\r2\006\020\036\032\0020'H\007?\001\000?\006\002\020(?\002\004\n\002\b\031?\006)"}, d2={"checkUIntRangeBounds", "", "from", "Lkotlin/UInt;", "until", "checkUIntRangeBounds-J1ME1BU", "(II)V", "checkULongRangeBounds", "Lkotlin/ULong;", "checkULongRangeBounds-eb3DHEI", "(JJ)V", "nextUBytes", "Lkotlin/UByteArray;", "Lkotlin/random/Random;", "size", "", "(Lkotlin/random/Random;I)[B", "array", "nextUBytes-EVgfTAA", "(Lkotlin/random/Random;[B)[B", "fromIndex", "toIndex", "nextUBytes-Wvrt4B4", "(Lkotlin/random/Random;[BII)[B", "nextUInt", "(Lkotlin/random/Random;)I", "nextUInt-qCasIEU", "(Lkotlin/random/Random;I)I", "nextUInt-a8DCA5k", "(Lkotlin/random/Random;II)I", "range", "Lkotlin/ranges/UIntRange;", "(Lkotlin/random/Random;Lkotlin/ranges/UIntRange;)I", "nextULong", "(Lkotlin/random/Random;)J", "nextULong-V1Xi4fY", "(Lkotlin/random/Random;J)J", "nextULong-jmpaW-c", "(Lkotlin/random/Random;JJ)J", "Lkotlin/ranges/ULongRange;", "(Lkotlin/random/Random;Lkotlin/ranges/ULongRange;)J", "kotlin-stdlib"}, k=2, mv={1, 1, 16})
public final class URandomKt
{
  ...
  public static final int nextUInt(Random paramRandom, UIntRange paramUIntRange)
  {
    ...
    if (!paramUIntRange.isEmpty())
    {
      ...
      if (UnsignedKt.uintCompare(paramUIntRange.getLast(), -1) < 0) {
        i = nextUInt-a8DCA5k(paramRandom, paramUIntRange.getFirst(), UInt.constructor-impl(paramUIntRange.getLast() + 1));
      } else if (UnsignedKt.uintCompare(paramUIntRange.getFirst(), 0) > 0) {
        i = UInt.constructor-impl(nextUInt-a8DCA5k(paramRandom, UInt.constructor-impl(paramUIntRange.getFirst() - 1), paramUIntRange.getLast()) + 1);
      } else {
  ...
  public static final long nextULong(Random paramRandom, ULongRange paramULongRange)
  {
    ...
    if (!paramULongRange.isEmpty())
    {
      ...
      {
        l1 = nextULong-jmpaW-c(paramRandom, paramULongRange.getFirst(), ULong.constructor-impl(paramULongRange.getLast() + ULong.constructor-impl(1 & 0xFFFFFFFF)));
      }
      else if (UnsignedKt.ulongCompare(paramULongRange.getFirst(), 0L) > 0)
      {
        long l2 = paramULongRange.getFirst();
        l1 = 1 & 0xFFFFFFFF;
        l1 = ULong.constructor-impl(nextULong-jmpaW-c(paramRandom, ULong.constructor-impl(l2 - ULong.constructor-impl(l1)), paramULongRange.getLast()) + ULong.constructor-impl(l1));
      }
      else
      {
