...
public final class Route
{
  ...
  public boolean equals(Object paramObject)
  {
    if ((paramObject instanceof Route))
    {
      ...
      if ((Intrinsics.areEqual(paramObject.address, this.address)) && (Intrinsics.areEqual(paramObject.proxy, this.proxy)) && (Intrinsics.areEqual(paramObject.socketAddress, this.socketAddress))) {
        return true;
      }
    }
    boolean bool = false;
