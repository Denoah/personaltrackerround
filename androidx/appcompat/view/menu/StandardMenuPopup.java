  ...
  private boolean tryShow()
  {
    ...
    if (!this.mWasDismissed)
    {
      ...
      if (localObject1 != null)
      {
        ...
        if (i != 0) {
          ((ViewTreeObserver)localObject2).addOnGlobalLayoutListener(this.mGlobalLayoutListener);
        }
        ((View)localObject1).addOnAttachStateChangeListener(this.mAttachStateChangeListener);
        this.mPopup.setAnchorView((View)localObject1);
