...
{
  private static final KotlinType approximate(KotlinType paramKotlinType)
  {
    return (KotlinType)CapturedTypeApproximationKt.approximateCapturedTypes(paramKotlinType).getUpper();
  }
  
  private static final String debugInfo(TypeConstructor paramTypeConstructor)
  {
    StringBuilder localStringBuilder1 = new StringBuilder();
    Lambda local1 = new Lambda(localStringBuilder1)
    {
      public final StringBuilder invoke(String paramAnonymousString)
      {
        Intrinsics.checkParameterIsNotNull(paramAnonymousString, "$this$unaryPlus");
  ...
  public static final KotlinType findCorrespondingSupertype(KotlinType paramKotlinType1, KotlinType paramKotlinType2, TypeCheckingProcedureCallbacks paramTypeCheckingProcedureCallbacks)
  {
