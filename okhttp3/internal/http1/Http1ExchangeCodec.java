  ...
  public Response.Builder readResponseHeaders(boolean paramBoolean)
  {
    ...
    if (k != 0) {
      try
      {
        ...
        localObject = ((Response.Builder)localObject).protocol(localStatusLine.protocol).code(localStatusLine.code).message(localStatusLine.message).headers(readHeaders());
      ...
      {
        String str = getConnection().route().address().url().redact();
        localObject = new StringBuilder();
        ((StringBuilder)localObject).append("unexpected end of stream on ");
        ((StringBuilder)localObject).append(str);
        throw ((Throwable)new IOException(((StringBuilder)localObject).toString(), (Throwable)localEOFException));
      }
    }
    ...
    extends Http1ExchangeCodec.AbstractSource
  {
    ...
    private final void readChunkSize()
    {
      ...
      try
      {
        ...
        {
          Object localObject2 = StringsKt.trim((CharSequence)localObject1).toString();
          if (this.bytesRemainingInChunk >= 0L)
          {
            ...
            if (i != 0)
            {
              boolean bool = StringsKt.startsWith$default((String)localObject2, ";", false, 2, null);
              if (!bool) {}
            }
            else
            {
              if (this.bytesRemainingInChunk == 0L)
              {
                ...
                localObject3 = ((OkHttpClient)localObject1).cookieJar();
                localObject1 = this.url;
                localObject2 = Http1ExchangeCodec.access$getTrailers$p(Http1ExchangeCodec.this);
                if (localObject2 == null) {
                  Intrinsics.throwNpe();
                }
                HttpHeaders.receiveHeaders((CookieJar)localObject3, (HttpUrl)localObject1, (Headers)localObject2);
                responseBodyComplete$okhttp();
              }
              return;
            }
          }
          Object localObject3 = new java/net/ProtocolException;
          localObject1 = new java/lang/StringBuilder;
          ((StringBuilder)localObject1).<init>();
          ((StringBuilder)localObject1).append("expected chunk size and optional extensions");
          ((StringBuilder)localObject1).append(" but was \"");
          ((StringBuilder)localObject1).append(this.bytesRemainingInChunk);
          ((StringBuilder)localObject1).append((String)localObject2);
          ((StringBuilder)localObject1).append('"');
          ((ProtocolException)localObject3).<init>(((StringBuilder)localObject1).toString());
          throw ((Throwable)localObject3);
        }
        localObject1 = new kotlin/TypeCastException;
        ((TypeCastException)localObject1).<init>("null cannot be cast to non-null type kotlin.CharSequence");
