  ...
  extends SetsKt__SetsKt
{
  ...
  public static final <T> Set<T> minus(Set<? extends T> paramSet, Iterable<? extends T> paramIterable)
  {
    ...
    paramIterable = CollectionsKt.convertToSetForSetOperationWith(paramIterable, (Iterable)localObject);
    if (paramIterable.isEmpty()) {
      return CollectionsKt.toSet((Iterable)localObject);
    }
  ...
  public static final <T> Set<T> minus(Set<? extends T> paramSet, T paramT)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (i == 0)
      {
        k = i;
        m = j;
        if (Intrinsics.areEqual(paramSet, paramT))
        {
          k = 1;
          m = 0;
        }
      ...
      if (m != 0)
      {
        ((Collection)localLinkedHashSet).add(paramSet);
        i = k;
      }
    }
