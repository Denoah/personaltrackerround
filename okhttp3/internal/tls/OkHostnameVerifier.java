  ...
  implements HostnameVerifier
{
  ...
  private final boolean verifyHostname(String paramString1, String paramString2)
  {
    ...
    if ((i == 0) && (!StringsKt.startsWith$default((String)localObject, ".", false, 2, null)) && (!StringsKt.endsWith$default((String)localObject, "..", false, 2, null)))
    {
      ...
      if ((i == 0) && (!StringsKt.startsWith$default(paramString2, ".", false, 2, null)) && (!StringsKt.endsWith$default(paramString2, "..", false, 2, null)))
      {
        ...
        if (localObject != null)
        {
          ...
          if ((StringsKt.startsWith$default(paramString2, "*.", false, 2, null)) && (StringsKt.indexOf$default((CharSequence)localObject, '*', 1, false, 4, null) == -1))
          {
  ...
  private final boolean verifyHostname(String paramString, X509Certificate paramX509Certificate)
  {
    ...
    if (paramString != null)
    {
      ...
      else
      {
        ...
        } while (!INSTANCE.verifyHostname(paramString, paramX509Certificate));
        bool1 = true;
      }
      return bool1;
    }
  ...
  public boolean verify(String paramString, SSLSession paramSSLSession)
  {
    ...
    try
    {
      ...
      {
        bool2 = verify(paramString, (X509Certificate)paramSSLSession);
      }
      else
      {
