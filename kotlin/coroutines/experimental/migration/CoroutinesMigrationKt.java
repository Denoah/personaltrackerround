...
public final class CoroutinesMigrationKt
{
  public static final <T> kotlin.coroutines.Continuation<T> toContinuation(kotlin.coroutines.experimental.Continuation<? super T> paramContinuation)
  {
    ...
    if (localObject != null)
    {
      ...
      if (localObject != null) {
        return (kotlin.coroutines.experimental.Continuation<? super T>)localObject;
      }
    }
    paramContinuation = (kotlin.coroutines.Continuation)new ContinuationMigration(paramContinuation);
  ...
  public static final kotlin.coroutines.ContinuationInterceptor toContinuationInterceptor(kotlin.coroutines.experimental.ContinuationInterceptor paramContinuationInterceptor)
  {
    ...
    paramContinuationInterceptor = (kotlin.coroutines.ContinuationInterceptor)new ContinuationInterceptorMigration(paramContinuationInterceptor);
  ...
  public static final kotlin.coroutines.CoroutineContext toCoroutineContext(kotlin.coroutines.experimental.CoroutineContext paramCoroutineContext)
  {
    ...
    if (localContinuationInterceptor != null) {
      paramCoroutineContext = paramCoroutineContext.plus((kotlin.coroutines.CoroutineContext)toContinuationInterceptor(localContinuationInterceptor));
    }
  ...
  public static final <T> kotlin.coroutines.experimental.Continuation<T> toExperimentalContinuation(kotlin.coroutines.Continuation<? super T> paramContinuation)
  {
    ...
    if (localObject != null)
    {
      ...
      if (localObject != null) {
        return (kotlin.coroutines.Continuation<? super T>)localObject;
      }
    }
    paramContinuation = (kotlin.coroutines.experimental.Continuation)new ExperimentalContinuationMigration(paramContinuation);
    return paramContinuation;
  }
  ...
  public static final kotlin.coroutines.experimental.ContinuationInterceptor toExperimentalContinuationInterceptor(kotlin.coroutines.ContinuationInterceptor paramContinuationInterceptor)
  {
    ...
    paramContinuationInterceptor = (kotlin.coroutines.experimental.ContinuationInterceptor)new ExperimentalContinuationInterceptorMigration(paramContinuationInterceptor);
    return paramContinuationInterceptor;
  }
  ...
  public static final kotlin.coroutines.experimental.CoroutineContext toExperimentalCoroutineContext(kotlin.coroutines.CoroutineContext paramCoroutineContext)
  {
    ...
    if (localContinuationInterceptor != null) {
      paramCoroutineContext = paramCoroutineContext.plus((kotlin.coroutines.experimental.CoroutineContext)toExperimentalContinuationInterceptor(localContinuationInterceptor));
    }
    return paramCoroutineContext;
  }
