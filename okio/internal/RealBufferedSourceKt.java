...
public final class RealBufferedSourceKt
{
  ...
  public static final boolean commonExhausted(RealBufferedSource paramRealBufferedSource)
  {
    ...
    boolean bool1 = paramRealBufferedSource.closed;
    boolean bool2 = true;
    if ((bool1 ^ true))
    {
  ...
  public static final long commonReadHexadecimalUnsignedLong(RealBufferedSource paramRealBufferedSource)
  {
    ...
    if (i == 0)
    {
      ...
      paramRealBufferedSource = Integer.toString(k, CharsKt.checkRadix(CharsKt.checkRadix(16)));
      Intrinsics.checkExpressionValueIsNotNull(paramRealBufferedSource, "java.lang.Integer.toStri…(this, checkRadix(radix))");
      localStringBuilder.append(paramRealBufferedSource);
