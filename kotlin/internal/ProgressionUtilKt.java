  ...
  public static final int getProgressionLastElement(int paramInt1, int paramInt2, int paramInt3)
  {
    if (paramInt3 > 0)
    {
      if (paramInt1 < paramInt2) {
        paramInt2 -= differenceModulo(paramInt2, paramInt1, paramInt3);
      }
    }
    else
    {
      ...
      if (paramInt1 > paramInt2) {
        paramInt2 += differenceModulo(paramInt1, paramInt2, -paramInt3);
      }
    }
    return paramInt2;
    label48:
  ...
  public static final long getProgressionLastElement(long paramLong1, long paramLong2, long paramLong3)
  {
    ...
    if (bool)
    {
      if (paramLong1 < paramLong2) {
        paramLong2 -= differenceModulo(paramLong2, paramLong1, paramLong3);
      }
    }
    else
    {
      ...
      if (paramLong1 > paramLong2) {
        paramLong2 += differenceModulo(paramLong1, paramLong2, -paramLong3);
      }
    }
    return paramLong2;
    label60:
