  ...
  implements Sequence<T>, DropTakeSequence<T>
{
  ...
  public Sequence<T> drop(int paramInt)
  {
    ...
    if (paramInt >= i) {
      ...
      localSequence = (Sequence)new SubSequence(this.sequence, paramInt, i);
    }
