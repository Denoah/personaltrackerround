  ...
  implements Continuation<Object>, CoroutineStackFrame, Serializable
{
  ...
  {
    Continuation localContinuation1 = this.completion;
  ...
  public final void resumeWith(Object paramObject)
  {
    ...
    for (BaseContinuationImpl localBaseContinuationImpl = (BaseContinuationImpl)this;; localBaseContinuationImpl = (BaseContinuationImpl)localContinuation)
    {
      ...
      try
      {
        Object localObject = localBaseContinuationImpl.invokeSuspend(paramObject);
        if (localObject == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
          return;
        }
        paramObject = Result.Companion;
        paramObject = Result.constructor-impl(localObject);
      }
      finally
      {
        paramObject = Result.Companion;
