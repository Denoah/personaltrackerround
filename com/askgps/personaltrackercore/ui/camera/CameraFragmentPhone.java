  ...
  extends DialogFragment
{
  ...
  private final void FaceDetectorAnalyzerCalbback(ImageCapture paramImageCapture, final ImageProxy paramImageProxy)
  {
    ...
    paramImageCapture.takePicture(new ImageCapture.OutputFileOptions.Builder(localFile).build(), (Executor)Executors.newSingleThreadExecutor(), (ImageCapture.OnImageSavedCallback)new ImageCapture.OnImageSavedCallback()
    {
      ...
      public void onImageSaved(ImageCapture.OutputFileResults paramAnonymousOutputFileResults)
      {
        ...
        this.this$0.dismiss();
        paramAnonymousOutputFileResults = CameraFragmentPhone.access$getViewModel$p(this.this$0);
        String str = localFile.getAbsolutePath();
        Intrinsics.checkExpressionValueIsNotNull(str, "file.absolutePath");
        paramAnonymousOutputFileResults.registerUser(str);
      }
    });
  }
  ...
  private final void initAvd()
  {
    ...
    AppCompatImageView localAppCompatImageView = (AppCompatImageView)_$_findCachedViewById(R.id.camera_face_detector_animation);
    localObject = this.avd;
    if (localObject == null) {
      Intrinsics.throwUninitializedPropertyAccessException("avd");
    }
    localAppCompatImageView.setImageDrawable((Drawable)localObject);
    localObject = this.avd;
    if (localObject == null) {
      Intrinsics.throwUninitializedPropertyAccessException("avd");
    }
    ((AnimatedVectorDrawableCompat)localObject).registerAnimationCallback((Animatable2Compat.AnimationCallback)new Animatable2Compat.AnimationCallback()
    {
      public void onAnimationEnd(Drawable paramAnonymousDrawable)
      {
        ...
        ((AppCompatImageView)this.this$0._$_findCachedViewById(R.id.camera_face_detector_animation)).post((Runnable)new Runnable()
        {
          ...
          {
            CameraFragmentPhone.access$getAvd$p(this.this$0.this$0).start();
          }
        });
      }
    });
  ...
  private final ImageCapture initCapture()
  {
    ...
    ((AppCompatButton)_$_findCachedViewById(R.id.camera_btn_send)).setOnClickListener((View.OnClickListener)new View.OnClickListener()
    {
      ...
      {
        CameraFragmentPhone.access$FaceDetectorAnalyzerCalbback(this.this$0, localImageCapture, null);
      }
    });
  ...
  private final ImageAnalysis initImageAnalysis(final ImageCapture paramImageCapture)
  {
    ...
    localImageAnalysis.setAnalyzer((Executor)Executors.newSingleThreadExecutor(), (ImageAnalysis.Analyzer)new FaceDetector.FaceDetectorAnalyzer((Function1)new Lambda(paramImageCapture)
    {
      public final void invoke(ImageProxy paramAnonymousImageProxy)
      {
        ...
        {
          AppCompatButton localAppCompatButton = (AppCompatButton)this.this$0._$_findCachedViewById(R.id.camera_btn_send);
          Intrinsics.checkExpressionValueIsNotNull(localAppCompatButton, "camera_btn_send");
          localAppCompatButton.setVisibility(8);
          CameraFragmentPhone.access$FaceDetectorAnalyzerCalbback(this.this$0, paramImageCapture, paramAnonymousImageProxy);
        }
        else
        {
          paramAnonymousImageProxy = (AppCompatButton)this.this$0._$_findCachedViewById(R.id.camera_btn_send);
          Intrinsics.checkExpressionValueIsNotNull(paramAnonymousImageProxy, "camera_btn_send");
          paramAnonymousImageProxy.setVisibility(0);
        }
      }
    }));
  ...
  private final void startCamera()
  {
    ...
    final ListenableFuture localListenableFuture = ProcessCameraProvider.getInstance(localContext.getApplicationContext());
    Intrinsics.checkExpressionValueIsNotNull(localListenableFuture, "ProcessCameraProvider.ge…ext!!.applicationContext)");
    Runnable localRunnable = (Runnable)new Runnable()
    {
      public final void run()
      {
        ProcessCameraProvider localProcessCameraProvider = (ProcessCameraProvider)localListenableFuture.get();
        ImageCapture localImageCapture = CameraFragmentPhone.access$initCapture(this.this$0);
        ImageAnalysis localImageAnalysis = CameraFragmentPhone.access$initImageAnalysis(this.this$0, localImageCapture);
        Preview localPreview = CameraFragmentPhone.access$initPreview(this.this$0);
        CameraSelector localCameraSelector = CameraFragmentPhone.access$initCameraSelector(this.this$0);
    ...
    localListenableFuture.addListener(localRunnable, ContextCompat.getMainExecutor(localContext));
  }
  ...
  private final void updateTransform()
  {
    ...
    localObject = (PreviewView)_$_findCachedViewById(R.id.camera_preview);
    Intrinsics.checkExpressionValueIsNotNull(localObject, "camera_preview");
    float f4 = ((PreviewView)localObject).getWidth();
    localObject = (PreviewView)_$_findCachedViewById(R.id.camera_preview);
    Intrinsics.checkExpressionValueIsNotNull(localObject, "camera_preview");
    localMatrix.postScale(f3, f4 / ((PreviewView)localObject).getWidth(), f1, f2);
  }
  ...
  public void onActivityCreated(Bundle paramBundle)
  {
    ...
    if (BaseMainActivity.Companion.getCustomer() == CustomerCategory.BUILDER_WATCH)
    {
      ...
      paramBundle = paramBundle.getIdxId();
      LifecycleOwner localLifecycleOwner = getViewLifecycleOwner();
      Intrinsics.checkExpressionValueIsNotNull(localLifecycleOwner, "viewLifecycleOwner");
      paramBundle.observe(localLifecycleOwner, (Observer)new Observer()
      {
    ...
    if (allPermissionsGranted()) {
      ((PreviewView)_$_findCachedViewById(R.id.camera_preview)).post((Runnable)new Runnable()
      {
        public final void run()
        {
          CameraFragmentPhone.access$startCamera(this.this$0);
        }
      });
    } else {
  ...
  @Metadata(bv={1, 0, 3}, d1={"\000$\n\002\030\002\n\002\020\000\n\002\b\002\n\002\020\b\n\000\n\002\020\021\n\002\020\016\n\002\b\004\n\002\030\002\n\000\b?\003\030\0002\0020\001B\007\b\002?\006\002\020\002J\006\020\013\032\0020\fR\016\020\003\032\0020\004X?T?\006\002\n\000R\031\020\005\032\b\022\004\022\0020\0070\006?\006\n\n\002\020\n\032\004\b\b\020\t?\006\r"}, d2={"Lcom/askgps/personaltrackercore/ui/camera/CameraFragmentPhone$Companion;", "", "()V", "REQUEST_CAMERA_PERMISSION", "", "REQUIRED_PERMISSIONS", "", "", "getREQUIRED_PERMISSIONS", "()[Ljava/lang/String;", "[Ljava/lang/String;", "newInstance", "Lcom/askgps/personaltrackercore/ui/camera/CameraFragmentPhone;", "personaltrackercore_release"}, k=1, mv={1, 1, 16})
  public static final class Companion
  {
    ...
    {
      return CameraFragmentPhone.access$getREQUIRED_PERMISSIONS$cp();
    }
