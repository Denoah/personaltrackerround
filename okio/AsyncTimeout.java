  ...
  public final Sink sink(final Sink paramSink)
  {
    ...
    (Sink)new Sink()
    {
      ...
      public void close()
      {
        ...
        //   0	77	0	this	1
        //   4	67	1	localAsyncTimeout	AsyncTimeout
        //   21	1	2	localUnit	Unit
        //   39	1	2	localObject1	Object
        //   43	9	2	localIOException	IOException
        //   55	21	2	localObject2	Object
        // Exception table:
        //   from	to	target	type
        //   9	22	39	finally
        //   44	51	39	finally
      ...
      public void write(Buffer paramAnonymousBuffer, long paramAnonymousLong)
      {
        ...
        //   16	153	4	l1	long
        //   28	130	6	localObject1	Object
        //   32	91	7	l2	long
        //   36	183	9	localObject2	Object
        // Exception table:
        //   from	to	target	type
        //   142	159	185	finally
        //   190	198	185	finally
  ...
  public static final class Companion
  {
    ...
    private final void scheduleTimeout(AsyncTimeout paramAsyncTimeout, long paramLong, boolean paramBoolean)
    {
      try
      {
        ...
        AsyncTimeout localAsyncTimeout = AsyncTimeout.access$getHead$cp();
        Object localObject = localAsyncTimeout;
        if (localAsyncTimeout == null)
        {
          Intrinsics.throwNpe();
          localObject = localAsyncTimeout;
        }
        while (AsyncTimeout.access$getNext$p((AsyncTimeout)localObject) != null)
        {
          localAsyncTimeout = AsyncTimeout.access$getNext$p((AsyncTimeout)localObject);
          if (localAsyncTimeout == null) {
            Intrinsics.throwNpe();
          }
      ...
      throws InterruptedException
    {
      ...
      long l2 = AsyncTimeout.access$remainingNanos((AsyncTimeout)localObject, System.nanoTime());
      if (l2 > 0L)
      {
        l1 = l2 / 1000000L;
