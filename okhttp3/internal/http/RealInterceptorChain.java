  ...
  implements Interceptor.Chain
{
    ...
    throws IOException
  {
    ...
    if (j != 0)
    {
      ...
      RealInterceptorChain localRealInterceptorChain = copy$okhttp$default(this, this.index + 1, null, paramRequest, 0, 0, 0, 58, null);
      paramRequest = (Interceptor)this.interceptors.get(this.index);
      localObject = paramRequest.intercept((Interceptor.Chain)localRealInterceptorChain);
      if (localObject != null)
      {
        if (this.exchange != null)
        {
          if ((this.index + 1 < this.interceptors.size()) && (localRealInterceptorChain.calls != 1)) {
            j = 0;
          } else {
            j = 1;
          }
        ...
        j = k;
        if (((Response)localObject).body() != null) {
          j = 1;
        }
        if (j != 0) {
          return localObject;
