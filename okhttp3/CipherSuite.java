  ...
  public static final class Companion
  {
    ...
    public final CipherSuite forJavaName(String paramString)
    {
      try
      {
        ...
        CipherSuite localCipherSuite1 = (CipherSuite)CipherSuite.access$getINSTANCES$cp().get(paramString);
        CipherSuite localCipherSuite2 = localCipherSuite1;
        if (localCipherSuite1 == null)
        {
          localCipherSuite1 = (CipherSuite)CipherSuite.access$getINSTANCES$cp().get(((Companion)this).secondaryName(paramString));
          localCipherSuite2 = localCipherSuite1;
          if (localCipherSuite1 == null)
          {
            localCipherSuite2 = new okhttp3/CipherSuite;
            localCipherSuite2.<init>(paramString, null);
          }
          CipherSuite.access$getINSTANCES$cp().put(paramString, localCipherSuite2);
        }
