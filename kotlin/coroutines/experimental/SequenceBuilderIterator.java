  ...
  private final Throwable exceptionalState()
  {
    ...
    if (i != 4)
    {
      if (i != 5)
      {
        ...
        ((StringBuilder)localObject).append("Unexpected state of the iterator: ");
        ((StringBuilder)localObject).append(this.state);
        localObject = (Throwable)new IllegalStateException(((StringBuilder)localObject).toString());
      }
      else
      {
        localObject = (Throwable)new IllegalStateException("Iterator has failed.");
      }
    }
    else {
