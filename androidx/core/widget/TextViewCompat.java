...
public final class TextViewCompat
{
  ...
  private static TextDirectionHeuristic getTextDirectionHeuristic(TextView paramTextView)
  {
    ...
    {
      j = Character.getDirectionality(android.icu.text.DecimalFormatSymbols.getInstance(paramTextView.getTextLocale()).getDigitStrings()[0].codePointAt(0));
      if ((j != 1) && (j != 2)) {
        return TextDirectionHeuristics.LTR;
      }
    ...
    implements ActionMode.Callback
  {
    ...
    {
      Object localObject1 = this.mTextView.getContext();
      ...
      try
      {
        if ((this.mCanUseMenuBuilderReferences) && (this.mMenuBuilderClass.isInstance(paramMenu))) {
          localObject2 = this.mMenuBuilderRemoveItemAtMethod;
        } else {
        ...
        Object localObject2 = getSupportedActivities((Context)localObject1, localPackageManager);
