  ...
  implements Sequence<T>, DropTakeSequence<T>
{
  ...
  public Sequence<T> take(int paramInt)
  {
    ...
    else
    {
      ...
      localSequence = (Sequence)new SubSequence(localSequence, i, paramInt + i);
    }
    return localSequence;
  }
}
