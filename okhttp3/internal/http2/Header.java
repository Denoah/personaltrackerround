  ...
  public boolean equals(Object paramObject)
  {
    if (this != paramObject) {
      if ((paramObject instanceof Header))
      {
        ...
        if ((Intrinsics.areEqual(this.name, paramObject.name)) && (Intrinsics.areEqual(this.value, paramObject.value))) {}
      }
      else
      {
        return false;
