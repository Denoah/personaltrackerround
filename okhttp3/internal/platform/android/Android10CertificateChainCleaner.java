  ...
  extends CertificateChainCleaner
{
  ...
  {
    boolean bool;
    if (((paramObject instanceof Android10CertificateChainCleaner)) && (((Android10CertificateChainCleaner)paramObject).trustManager == this.trustManager)) {
      bool = true;
    } else {
      bool = false;
    }
  ...
  public static final class Companion
  {
    ...
    public final Android10CertificateChainCleaner buildIfSupported(X509TrustManager paramX509TrustManager)
    {
      ...
      if (localX509TrustManagerExtensions2 != null) {
        localAndroid10CertificateChainCleaner = new Android10CertificateChainCleaner(paramX509TrustManager, localX509TrustManagerExtensions2);
      }
