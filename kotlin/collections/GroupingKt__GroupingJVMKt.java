...
class GroupingKt__GroupingJVMKt
{
  ...
  public static final <T, K> Map<K, Integer> eachCount(Grouping<T, ? extends K> paramGrouping)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      int i;
      if ((localObject2 == null) && (!localMap.containsKey(localObject1))) {
        i = 1;
      } else {
        i = 0;
      }
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      if (paramGrouping != null) {
        TypeIntrinsics.asMutableMapEntry(paramGrouping).setValue(Integer.valueOf(((Ref.IntRef)paramGrouping.getValue()).element));
      } else {
