  ...
  extends StringsKt__StringsJVMKt
{
  ...
  public static final String commonPrefixWith(CharSequence paramCharSequence1, CharSequence paramCharSequence2, boolean paramBoolean)
  {
    ...
    for (int j = 0; (j < i) && (CharsKt.equals(paramCharSequence1.charAt(j), paramCharSequence2.charAt(j), paramBoolean)); j++) {}
    int k = j - 1;
  ...
  public static final String commonSuffixWith(CharSequence paramCharSequence1, CharSequence paramCharSequence2, boolean paramBoolean)
  {
    ...
    int k = Math.min(i, j);
    for (int m = 0; (m < k) && (CharsKt.equals(paramCharSequence1.charAt(i - m - 1), paramCharSequence2.charAt(j - m - 1), paramBoolean)); m++) {}
    if (!StringsKt.hasSurrogatePairAt(paramCharSequence1, i - m - 1))
    {
      k = m;
      if (!StringsKt.hasSurrogatePairAt(paramCharSequence2, j - m - 1)) {}
    }
    else
    {
      k = m - 1;
    }
    return paramCharSequence1.subSequence(i - k, i).toString();
  }
  ...
  private static final Pair<Integer, String> findAnyOf$StringsKt__StringsKt(CharSequence paramCharSequence, Collection<String> paramCollection, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (!paramBoolean2) {
      localObject1 = (IntProgression)new IntRange(RangesKt.coerceAtLeast(paramInt, 0), paramCharSequence.length());
    } else {
      localObject1 = RangesKt.downTo(RangesKt.coerceAtMost(paramInt, StringsKt.getLastIndex(paramCharSequence)), 0);
    }
    int i;
    int j;
    Object localObject2;
    ...
    {
      paramInt = ((IntProgression)localObject1).getFirst();
      i = ((IntProgression)localObject1).getLast();
      j = ((IntProgression)localObject1).getStep();
      if (j >= 0 ? paramInt <= i : paramInt >= i) {
        for (;;)
        {
          ...
          while (((Iterator)localObject2).hasNext())
          {
            ...
            if (StringsKt.regionMatches((String)localObject3, 0, (String)paramCharSequence, paramInt, ((String)localObject3).length(), paramBoolean1)) {
              break label232;
            }
          }
          localObject1 = null;
    ...
    else
    {
      ...
      i = ((IntProgression)localObject1).getStep();
      if (i >= 0 ? paramInt <= j : paramInt >= j) {
        for (;;)
        {
          ...
          while (((Iterator)localObject3).hasNext())
          {
            ...
            if (StringsKt.regionMatchesImpl((CharSequence)localObject2, 0, paramCharSequence, paramInt, ((String)localObject2).length(), paramBoolean1)) {
              break label371;
            }
          }
          localObject1 = null;
  ...
  public static final boolean hasSurrogatePairAt(CharSequence paramCharSequence, int paramInt)
  {
    ...
    boolean bool = true;
    if ((paramInt < 0) || (i - 2 < paramInt) || (!Character.isHighSurrogate(paramCharSequence.charAt(paramInt))) || (!Character.isLowSurrogate(paramCharSequence.charAt(paramInt + 1)))) {
      bool = false;
    }
    return bool;
  }
  ...
  public static final int lastIndexOfAny(CharSequence paramCharSequence, char[] paramArrayOfChar, int paramInt, boolean paramBoolean)
  {
    ...
    for (paramInt = RangesKt.coerceAtMost(paramInt, StringsKt.getLastIndex(paramCharSequence)); paramInt >= 0; paramInt--)
    {
      char c = paramCharSequence.charAt(paramInt);
  ...
  public static final String replaceAfter(String paramString1, char paramChar, String paramString2, String paramString3)
  {
    ...
    if (i != -1) {
      paramString3 = StringsKt.replaceRange(localCharSequence, i + 1, paramString1.length(), (CharSequence)paramString2).toString();
    }
    return paramString3;
  }
  ...
  public static final String replaceAfter(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    if (i != -1) {
      paramString4 = StringsKt.replaceRange(localCharSequence, i + paramString2.length(), paramString1.length(), (CharSequence)paramString3).toString();
    }
    return paramString4;
  }
  ...
  public static final String replaceBefore(String paramString1, char paramChar, String paramString2, String paramString3)
  {
    ...
    if (i != -1) {
      paramString3 = StringsKt.replaceRange(paramString1, 0, i, (CharSequence)paramString2).toString();
    }
    return paramString3;
  }
  ...
  public static final String replaceBefore(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    if (i != -1) {
      paramString4 = StringsKt.replaceRange(paramString1, 0, i, (CharSequence)paramString3).toString();
    }
    return paramString4;
  }
  ...
  private static final List<String> split$StringsKt__StringsKt(CharSequence paramCharSequence, String paramString, boolean paramBoolean, int paramInt)
  {
    ...
    if (j != 0)
    {
      ...
      if ((k != -1) && (paramInt != 1))
      {
        ...
        int m = 10;
        if (j != 0) {
          m = RangesKt.coerceAtMost(paramInt, 10);
        }
        ...
        do
        {
          ...
          n = StringsKt.indexOf(paramCharSequence, paramString, k, paramBoolean);
          i = k;
          m = n;
        } while (n != -1);
  ...
  public static final String substringAfter(String paramString1, String paramString2, String paramString3)
  {
    ...
    if (i != -1)
    {
      ...
      Intrinsics.checkExpressionValueIsNotNull(paramString3, "(this as java.lang.Strin…ing(startIndex, endIndex)");
    }
    return paramString3;
  }
  ...
  public static final CharSequence trimStart(CharSequence paramCharSequence)
  {
    ...
    int i = paramCharSequence.length();
    for (int j = 0; j < i; j++) {
      if (!CharsKt.isWhitespace(paramCharSequence.charAt(j))) {
  ...
  public static final CharSequence trimStart(CharSequence paramCharSequence, char... paramVarArgs)
  {
    ...
    int i = paramCharSequence.length();
    for (int j = 0; j < i; j++) {
      if (!ArraysKt.contains(paramVarArgs, paramCharSequence.charAt(j))) {
        return paramCharSequence.subSequence(j, paramCharSequence.length());
      }
    }
    paramCharSequence = (CharSequence)"";
  ...
  public static final String trimStart(String paramString, Function1<? super Character, Boolean> paramFunction1)
  {
    ...
    for (int j = 0; j < i; j++) {
      ...
      {
        paramString = paramString.subSequence(j, paramString.length());
        break label88;
      }
    }
    paramString = (CharSequence)"";
  ...
  public static final String trimStart(String paramString, char... paramVarArgs)
  {
    ...
    int i = paramString.length();
    for (int j = 0; j < i; j++) {
      if (!ArraysKt.contains(paramVarArgs, paramString.charAt(j)))
      {
        paramString = paramString.subSequence(j, paramString.length());
        break label77;
      }
