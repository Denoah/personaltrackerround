...
public final class Address
{
  ...
  public boolean equals(Object paramObject)
  {
    if ((paramObject instanceof Address))
    {
      ...
      if ((Intrinsics.areEqual(localHttpUrl, paramObject.url)) && (equalsNonHost$okhttp(paramObject))) {
        return true;
      }
    }
    boolean bool = false;
  ...
  public String toString()
  {
    ...
    localStringBuilder1.append(this.url.host());
    localStringBuilder1.append(':');
    localStringBuilder1.append(this.url.port());
    localStringBuilder1.append(", ");
    ...
    if (this.proxy != null)
    {
      ...
      localStringBuilder2.append("proxy=");
      localObject = this.proxy;
    }
    else
    {
      localStringBuilder2 = new StringBuilder();
      localStringBuilder2.append("proxySelector=");
