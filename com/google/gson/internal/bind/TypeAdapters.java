  ...
  static
  {
    ...
    localObject = new TypeAdapter()
    {
        ...
        throws IOException
      {
        ...
        localObject1 = new StringTokenizer(paramAnonymousJsonReader.nextString(), "_");
        if (((StringTokenizer)localObject1).hasMoreElements()) {
          paramAnonymousJsonReader = ((StringTokenizer)localObject1).nextToken();
        } else {
        ...
        if (str == null) {
          return new Locale(paramAnonymousJsonReader, (String)localObject2);
        }
        return new Locale(paramAnonymousJsonReader, (String)localObject2, str);
      }
        ...
        new TypeAdapter()
        {
            ...
            throws IOException
          {
            ...
            if ((localObject != null) && (!paramAnonymousGson.isInstance(localObject)))
            {
              ...
              paramAnonymous2JsonReader.append(paramAnonymousGson.getName());
