...
public class ResultPoint
{
  ...
  public static void orderBestPatterns(ResultPoint[] paramArrayOfResultPoint)
  {
    ...
    ResultPoint localResultPoint5 = localResultPoint3;
    if (crossProductZ(localResultPoint2, localResultPoint1, localResultPoint3) < 0.0F)
    {
      localResultPoint5 = localResultPoint2;
      localResultPoint4 = localResultPoint3;
    }
    paramArrayOfResultPoint[0] = localResultPoint4;
    paramArrayOfResultPoint[1] = localResultPoint1;
    paramArrayOfResultPoint[2] = localResultPoint5;
  }
