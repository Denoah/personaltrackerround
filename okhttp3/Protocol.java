...
public enum Protocol
{
  ...
  public static final class Companion
  {
      ...
      throws IOException
    {
      ...
      else if (Intrinsics.areEqual(paramString, Protocol.access$getProtocol$p(Protocol.HTTP_1_1)))
      {
        paramString = Protocol.HTTP_1_1;
      }
      else if (Intrinsics.areEqual(paramString, Protocol.access$getProtocol$p(Protocol.H2_PRIOR_KNOWLEDGE)))
      {
        paramString = Protocol.H2_PRIOR_KNOWLEDGE;
      }
      else if (Intrinsics.areEqual(paramString, Protocol.access$getProtocol$p(Protocol.HTTP_2)))
      {
        paramString = Protocol.HTTP_2;
      }
      else if (Intrinsics.areEqual(paramString, Protocol.access$getProtocol$p(Protocol.SPDY_3)))
      {
