  ...
  extends MathKt__MathHKt
{
  ...
  public static final double acosh(double paramDouble)
  {
    ...
    if (paramDouble < d1)
    {
      paramDouble = DoubleCompanionObject.INSTANCE.getNaN();
    }
    ...
    else
    {
      ...
      {
        paramDouble = Math.log(paramDouble + Math.sqrt(paramDouble * paramDouble - d1));
      }
      else
      {
        d1 = Math.sqrt(d2);
  ...
  public static final double asinh(double paramDouble)
  {
    ...
    if (paramDouble >= Constants.taylor_n_bound)
    {
      if (paramDouble > Constants.upper_taylor_n_bound)
      {
        ...
        {
          paramDouble *= 2;
          d = Math.log(paramDouble + 1 / paramDouble);
        }
      }
      else {
        d = Math.log(paramDouble + Math.sqrt(paramDouble * paramDouble + 1));
      }
    }
    else if (paramDouble <= -Constants.taylor_n_bound)
    {
      d = -MathKt.asinh(-paramDouble);
    }
    else
    {
      d = paramDouble;
