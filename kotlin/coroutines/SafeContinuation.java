  ...
  implements Continuation<T>, CoroutineStackFrame
{
  ...
  public final Object getOrThrow()
  {
    ...
    if (localObject1 == CoroutineSingletons.UNDECIDED)
    {
    ...
    if (localObject2 == CoroutineSingletons.RESUMED) {
