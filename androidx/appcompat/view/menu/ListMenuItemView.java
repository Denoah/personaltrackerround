  ...
  implements MenuView.ItemView, AbsListView.SelectionBoundsAdjuster
{
  ...
  protected void onFinishInflate()
  {
    ...
    this.mTitleView = ((TextView)localObject);
    int i = this.mTextAppearance;
    if (i != -1) {
      ((TextView)localObject).setTextAppearance(this.mTextAppearanceContext, i);
    }
    this.mShortcutView = ((TextView)findViewById(R.id.shortcut));
    localObject = (ImageView)findViewById(R.id.submenuarrow);
    this.mSubMenuArrowView = ((ImageView)localObject);
    if (localObject != null) {
      ((ImageView)localObject).setImageDrawable(this.mSubMenuArrow);
    }
