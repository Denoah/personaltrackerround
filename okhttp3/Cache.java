  ...
  implements Closeable, Flushable
{
  ...
  public final Response get$okhttp(Request paramRequest)
  {
    ...
    Object localObject1 = Companion.key(paramRequest.url());
    try
    {
      ...
      if (localObject2 != null) {
        try
        {
          ...
          {
            paramRequest = ((Response)localObject2).body();
  ...
  public static final class Companion
  {
    ...
    private final Set<String> varyFields(Headers paramHeaders)
    {
      ...
      label157:
      for (int j = 0; j < i; j++) {
        if (StringsKt.equals("Vary", paramHeaders.name(j), true))
        {
          Object localObject2 = paramHeaders.value(j);
          Object localObject3 = localObject1;
          if (localObject1 == null) {
            localObject3 = (Set)new TreeSet(StringsKt.getCASE_INSENSITIVE_ORDER(StringCompanionObject.INSTANCE));
          }
          localObject2 = StringsKt.split$default((CharSequence)localObject2, new char[] { ',' }, false, 0, 6, null).iterator();
          for (;;)
          {
            ...
            ((Set)localObject3).add(StringsKt.trim((CharSequence)localObject1).toString());
          }
          throw new TypeCastException("null cannot be cast to non-null type kotlin.CharSequence");
        }
      }
      if (localObject1 == null) {
        localObject1 = SetsKt.emptySet();
      }
      return localObject1;
    }
  ...
  private static final class Entry
  {
      ...
      throws IOException
    {
      try
      {
        ...
        int i = Cache.Companion.readInt$okhttp((BufferedSource)localObject1);
        int j = 0;
        for (int k = 0; k < i; k++) {
        ...
        Object localObject4 = new okhttp3/Headers$Builder;
        ((Headers.Builder)localObject4).<init>();
        i = Cache.Companion.readInt$okhttp((BufferedSource)localObject1);
        for (k = 0; k < i; k++) {
          ((Headers.Builder)localObject4).addLenient$okhttp(((BufferedSource)localObject1).readUtf8LineStrict());
        }
        localObject3 = ((Headers.Builder)localObject4).get(SENT_MILLIS);
        Object localObject5 = ((Headers.Builder)localObject4).get(RECEIVED_MILLIS);
        ((Headers.Builder)localObject4).removeAll(SENT_MILLIS);
        ((Headers.Builder)localObject4).removeAll(RECEIVED_MILLIS);
        long l1 = 0L;
        ...
        this.responseHeaders = ((Headers.Builder)localObject4).build();
        if (isHttps())
        {
    ...
    private final List<Certificate> readCertificateList(BufferedSource paramBufferedSource)
      throws IOException
    {
      int i = Cache.Companion.readInt$okhttp(paramBufferedSource);
      if (i == -1) {
      ...
      throws IOException
    {
      ...
      try
      {
        ...
        for (int k = 0; k < j; k++) {
          ((BufferedSink)localObject1).writeUtf8(this.varyHeaders.name(k)).writeUtf8(": ").writeUtf8(this.varyHeaders.value(k)).writeByte(10);
        }
        Object localObject3 = new okhttp3/internal/http/StatusLine;
        ((StatusLine)localObject3).<init>(this.protocol, this.code, this.message);
        ((BufferedSink)localObject1).writeUtf8(((StatusLine)localObject3).toString()).writeByte(10);
        ((BufferedSink)localObject1).writeDecimalLong(this.responseHeaders.size() + 2).writeByte(10);
        j = this.responseHeaders.size();
        for (k = i; k < j; k++) {
          ((BufferedSink)localObject1).writeUtf8(this.responseHeaders.name(k)).writeUtf8(": ").writeUtf8(this.responseHeaders.value(k)).writeByte(10);
        }
        ...
        if (isHttps())
        {
          ...
          localObject3 = this.handshake;
          if (localObject3 == null) {
            Intrinsics.throwNpe();
          }
          ((BufferedSink)localObject1).writeUtf8(((Handshake)localObject3).cipherSuite().javaName()).writeByte(10);
