  ...
  implements WebSocket, WebSocketReader.FrameCallback
{
    ...
    try
    {
      ...
      if (paramString != null)
      {
        ...
        if (i == 0)
        {
          ...
          ((IllegalArgumentException)localObject).<init>(paramString.toString());
      ...
      if ((!this.failed) && (!this.enqueuedClose))
      {
        ...
        paramString.<init>(paramInt, (ByteString)localObject, paramLong);
    ...
    throws IOException
  {
    ...
    try
    {
      ...
      ((WebSocketWriter)localObject1).<init>(paramStreams.getClient(), paramStreams.getSink(), this.random);
      ...
      if (this.pingIntervalMillis != 0L)
      {
        ...
        ((StringBuilder)localObject2).append(" ping");
        String str = ((StringBuilder)localObject2).toString();
        localObject2 = new okhttp3/internal/ws/RealWebSocket$initReaderAndWriter$$inlined$synchronized$lambda$1;
        ((initReaderAndWriter..inlined.synchronized.lambda.1)localObject2).<init>(str, str, l, this, paramString, paramStreams);
        ((TaskQueue)localObject1).schedule((Task)localObject2, l);
      }
  ...
  public void onReadClose(int paramInt, String paramString)
  {
    ...
    if (j != 0)
    {
      Object localObject1 = (Streams)null;
      try
      {
    ...
    throws IOException
  {
    ...
    try
    {
      ...
      Object localObject3 = this.writer;
      Object localObject4 = (ByteString)this.pongQueue.poll();
      if (localObject4 == null)
      {
        localObjectRef1.element = this.messageAndCloseQueue.poll();
        if ((localObjectRef1.element instanceof Close))
        {
          ((Ref.IntRef)localObject1).element = this.receivedCloseCode;
          localObjectRef2.element = this.receivedCloseReason;
          if (((Ref.IntRef)localObject1).element != -1)
          {
            ((Ref.ObjectRef)localObject2).element = this.streams;
            this.streams = ((Streams)null);
            this.taskQueue.shutdown();
          }
          else
          {
            localObject10 = localObjectRef1.element;
            if (localObject10 != null)
            {
              ...
              Task local1 = new okhttp3/internal/ws/RealWebSocket$writeOneFrame$$inlined$synchronized$lambda$1;
              local1.<init>((String)localObject11, true, (String)localObject11, true, this, (WebSocketWriter)localObject3, (ByteString)localObject4, localObjectRef1, (Ref.IntRef)localObject1, localObjectRef2, (Ref.ObjectRef)localObject2);
              ((TaskQueue)localObject10).schedule((Task)local1, l);
            }
            else
            {
              localObject4 = new kotlin/TypeCastException;
              ((TypeCastException)localObject4).<init>("null cannot be cast to non-null type okhttp3.internal.ws.RealWebSocket.Close");
      ...
      {
        Intrinsics.throwNpe();
        ((WebSocketWriter)localObject3).writePong((ByteString)localObject4);
        for (;;)
        {
          break label606;
          if (!(localObjectRef1.element instanceof Message)) {
            break label501;
          }
          localObject4 = localObjectRef1.element;
          if (localObject4 == null) {
            break label485;
          }
          localObject4 = ((Message)localObject4).getData();
          if (localObject3 == null) {
            Intrinsics.throwNpe();
          }
          localObject1 = localObjectRef1.element;
          if (localObject1 != null)
          {
            localObject3 = Okio.buffer(((WebSocketWriter)localObject3).newMessageSink(((Message)localObject1).getFormatOpcode(), ((ByteString)localObject4).size()));
            ((BufferedSink)localObject3).write((ByteString)localObject4);
            ((BufferedSink)localObject3).close();
            try
            {
              this.queueSize -= ((ByteString)localObject4).size();
        ...
        Object localObject6 = new kotlin/TypeCastException;
        ((TypeCastException)localObject6).<init>("null cannot be cast to non-null type okhttp3.internal.ws.RealWebSocket.Message");
        throw ((Throwable)localObject6);
        label485:
        localObject6 = new kotlin/TypeCastException;
        ((TypeCastException)localObject6).<init>("null cannot be cast to non-null type okhttp3.internal.ws.RealWebSocket.Message");
        throw ((Throwable)localObject6);
        label501:
        if ((localObjectRef1.element instanceof Close))
        {
          localObject6 = localObjectRef1.element;
          if (localObject6 != null)
          {
            localObject6 = (Close)localObject6;
            if (localObject3 == null) {
              Intrinsics.throwNpe();
            }
            ((WebSocketWriter)localObject3).writeClose(((Close)localObject6).getCode(), ((Close)localObject6).getReason());
          }
        }
        try
        {
          if ((Streams)((Ref.ObjectRef)localObject2).element != null)
          {
            localObject3 = this.listener;
            localObject6 = (WebSocket)this;
            int i = ((Ref.IntRef)localObject1).element;
            localObject1 = (String)localObjectRef2.element;
            if (localObject1 == null) {
              Intrinsics.throwNpe();
            }
            ((WebSocketListener)localObject3).onClosed((WebSocket)localObject6, i, (String)localObject1);
          }
          label606:
          localObject6 = (Streams)((Ref.ObjectRef)localObject2).element;
          if (localObject6 != null) {
        ...
        localObject6 = new kotlin/TypeCastException;
        ((TypeCastException)localObject6).<init>("null cannot be cast to non-null type okhttp3.internal.ws.RealWebSocket.Close");
        throw ((Throwable)localObject6);
        localObject6 = new java/lang/AssertionError;
        ((AssertionError)localObject6).<init>();
        throw ((Throwable)localObject6);
      }
      finally {}
      label670:
      localObject2 = (Streams)((Ref.ObjectRef)localObject2).element;
      if (localObject2 != null) {
        Util.closeQuietly((Closeable)localObject2);
      }
      throw localObject8;
