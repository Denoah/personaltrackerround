...
class IntrinsicsKt__IntrinsicsJvmKt
{
  ...
  private static final <T> Continuation<Unit> createCoroutineFromSuspendFunction$IntrinsicsKt__IntrinsicsJvmKt(final Continuation<? super T> paramContinuation, Function1<? super Continuation<? super T>, ? extends Object> paramFunction1)
  {
    ...
    if (localCoroutineContext == EmptyCoroutineContext.INSTANCE)
    {
      if (paramContinuation != null) {
        paramContinuation = (Continuation)new RestrictedContinuationImpl(paramFunction1)
        {
          private int label;
          ...
          protected Object invokeSuspend(Object paramAnonymousObject)
          {
            ...
            else
            {
              this.label = 1;
              ResultKt.throwOnFailure(paramAnonymousObject);
              paramAnonymousObject = this.$block.invoke(this);
            }
    ...
    else
    {
      ...
      paramContinuation = (Continuation)new ContinuationImpl(paramFunction1, paramContinuation)
      {
        private int label;
  ...
  public static final <T> Continuation<Unit> createCoroutineUnintercepted(final Function1<? super Continuation<? super T>, ? extends Object> paramFunction1, final Continuation<? super T> paramContinuation)
  {
    ...
    {
      paramFunction1 = ((BaseContinuationImpl)paramFunction1).create(localContinuation);
    }
    else
    {
      ...
      if (paramContinuation == EmptyCoroutineContext.INSTANCE)
      {
        if (localContinuation != null) {
          paramFunction1 = (Continuation)new RestrictedContinuationImpl(localContinuation)
          {
            private int label;
            ...
            protected Object invokeSuspend(Object paramAnonymousObject)
            {
              ...
              else
              {
                ...
                paramAnonymousObject = paramFunction1;
                if (paramAnonymousObject == null) {
                  break label82;
                }
                paramAnonymousObject = ((Function1)TypeIntrinsics.beforeCheckcastToFunctionOfArity(paramAnonymousObject, 1)).invoke(localContinuation);
              }
              return paramAnonymousObject;
              label82:
      ...
      else
      {
        ...
        paramFunction1 = (Continuation)new ContinuationImpl(localContinuation, paramContinuation)
        {
          private int label;
          ...
          protected Object invokeSuspend(Object paramAnonymousObject)
          {
            ...
            else
            {
              ...
              paramAnonymousObject = ((Function1)TypeIntrinsics.beforeCheckcastToFunctionOfArity(localFunction1, 1)).invoke(paramAnonymousObject);
            }
            return paramAnonymousObject;
            label82:
            throw new TypeCastException("null cannot be cast to non-null type (kotlin.coroutines.Continuation<T>) -> kotlin.Any?");
  ...
  public static final <R, T> Continuation<Unit> createCoroutineUnintercepted(final Function2<? super R, ? super Continuation<? super T>, ? extends Object> paramFunction2, final R paramR, final Continuation<? super T> paramContinuation)
  {
          ...
          paramFunction2 = (Continuation)new RestrictedContinuationImpl(localContinuation)
          {
            ...
            protected Object invokeSuspend(Object paramAnonymousObject)
            {
              ...
              else
              {
                ...
                paramAnonymousObject = ((Function2)TypeIntrinsics.beforeCheckcastToFunctionOfArity(paramAnonymousObject, 2)).invoke(paramR, localContinuation);
              }
              return paramAnonymousObject;
              label86:
        ...
        paramFunction2 = (Continuation)new ContinuationImpl(localContinuation, paramContinuation)
        {
          ...
          protected Object invokeSuspend(Object paramAnonymousObject)
          {
            ...
            else
            {
              ...
              paramAnonymousObject = ((Function2)TypeIntrinsics.beforeCheckcastToFunctionOfArity(localFunction2, 2)).invoke(paramR, paramAnonymousObject);
            }
            return paramAnonymousObject;
            label86:
            throw new TypeCastException("null cannot be cast to non-null type (R, kotlin.coroutines.Continuation<T>) -> kotlin.Any?");
