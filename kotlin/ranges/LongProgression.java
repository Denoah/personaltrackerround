  ...
  implements Iterable<Long>, KMappedMarker
{
  ...
  public int hashCode()
  {
    ...
    else
    {
      ...
      long l3 = this.last;
      long l4 = this.step;
      i = (int)(l1 * ((l2 ^ l2 >>> 32) * l1 + (l3 ^ l3 >>> 32)) + (l4 ^ l4 >>> 32));
    }
    return i;
  }
