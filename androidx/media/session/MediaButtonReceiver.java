  ...
  extends BroadcastReceiver
{
    ...
    extends MediaBrowserCompat.ConnectionCallback
  {
    ...
    public void onConnected()
    {
      try
      {
        MediaControllerCompat localMediaControllerCompat = new android/support/v4/media/session/MediaControllerCompat;
        localMediaControllerCompat.<init>(this.mContext, this.mMediaBrowser.getSessionToken());
        localMediaControllerCompat.dispatchMediaButtonEvent((KeyEvent)this.mIntent.getParcelableExtra("android.intent.extra.KEY_EVENT"));
      }
