...
public class AccessibilityNodeInfoCompat
{
  ...
  private List<Integer> extrasIntList(String paramString)
  {
    ...
    ArrayList localArrayList1 = this.mInfo.getExtras().getIntegerArrayList(paramString);
    ArrayList localArrayList2 = localArrayList1;
    if (localArrayList1 == null)
    {
      localArrayList2 = new ArrayList();
      this.mInfo.getExtras().putIntegerArrayList(paramString, localArrayList2);
    }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    return this.mParentVirtualDescendantId == paramObject.mParentVirtualDescendantId;
  }
  ...
  public CharSequence getText()
  {
    if (hasSpans())
    {
      ...
      {
        ((Spannable)localObject).setSpan(new AccessibilityClickableSpanCompat(((Integer)localList4.get(j)).intValue(), this, getExtras().getInt("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_ACTION_ID_KEY")), ((Integer)localList1.get(j)).intValue(), ((Integer)localList2.get(j)).intValue(), ((Integer)localList3.get(j)).intValue());
        j++;
      }
      return localObject;
    }
  ...
  public static class AccessibilityActionCompat
  {
    ...
    static
    {
      ...
      ACTION_SHOW_ON_SCREEN = new AccessibilityActionCompat(localObject2, 16908342, null, null, null);
      if (Build.VERSION.SDK_INT >= 23) {
        localObject2 = AccessibilityNodeInfo.AccessibilityAction.ACTION_SCROLL_TO_POSITION;
      } else {
        localObject2 = null;
      }
      ACTION_SCROLL_TO_POSITION = new AccessibilityActionCompat(localObject2, 16908343, null, null, AccessibilityViewCommand.ScrollToPositionArguments.class);
      if (Build.VERSION.SDK_INT >= 23) {
        localObject2 = AccessibilityNodeInfo.AccessibilityAction.ACTION_SCROLL_UP;
      } else {
        localObject2 = null;
      }
      ACTION_SCROLL_UP = new AccessibilityActionCompat(localObject2, 16908344, null, null, null);
      if (Build.VERSION.SDK_INT >= 23) {
        localObject2 = AccessibilityNodeInfo.AccessibilityAction.ACTION_SCROLL_LEFT;
      } else {
        localObject2 = null;
      }
      ACTION_SCROLL_LEFT = new AccessibilityActionCompat(localObject2, 16908345, null, null, null);
      if (Build.VERSION.SDK_INT >= 23) {
        localObject2 = AccessibilityNodeInfo.AccessibilityAction.ACTION_SCROLL_DOWN;
      } else {
        localObject2 = null;
      }
      ACTION_SCROLL_DOWN = new AccessibilityActionCompat(localObject2, 16908346, null, null, null);
      if (Build.VERSION.SDK_INT >= 23) {
        localObject2 = AccessibilityNodeInfo.AccessibilityAction.ACTION_SCROLL_RIGHT;
      } else {
        localObject2 = null;
      }
      ACTION_SCROLL_RIGHT = new AccessibilityActionCompat(localObject2, 16908347, null, null, null);
      if (Build.VERSION.SDK_INT >= 29) {
      ...
      ACTION_CONTEXT_CLICK = new AccessibilityActionCompat(localObject2, 16908348, null, null, null);
      if (Build.VERSION.SDK_INT >= 24) {
        localObject2 = AccessibilityNodeInfo.AccessibilityAction.ACTION_SET_PROGRESS;
      } else {
        localObject2 = null;
      }
      ACTION_SET_PROGRESS = new AccessibilityActionCompat(localObject2, 16908349, null, null, AccessibilityViewCommand.SetProgressArguments.class);
      if (Build.VERSION.SDK_INT >= 26) {
    ...
    public boolean equals(Object paramObject)
    {
      ...
      AccessibilityActionCompat localAccessibilityActionCompat = (AccessibilityActionCompat)paramObject;
      paramObject = this.mAction;
      if (paramObject == null)
      {
        if (localAccessibilityActionCompat.mAction != null) {
          return false;
        }
      }
      else if (!paramObject.equals(localAccessibilityActionCompat.mAction)) {
        return false;
      }
      return true;
    }
