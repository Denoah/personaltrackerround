  ...
  implements Runnable
{
  ...
  private void resolve(boolean paramBoolean)
  {
    ...
    try
    {
      List localList = this.mWorkDatabase.workSpecDao().getAllUnfinishedWork();
      int i;
  ...
  private void runWorker()
  {
    ...
    try
    {
      Object localObject1 = this.mWorkSpecDao.getWorkSpec(this.mWorkSpecId);
      ...
      for (localObject1 = this.mWorkSpec.input;; localObject1 = ((InputMerger)localObject1).merge(localArrayList))
      {
        break;
        localObject1 = this.mConfiguration.getInputMergerFactory().createInputMergerWithDefaultFallback(this.mWorkSpec.inputMergerClassName);
        if (localObject1 == null)
        {
        ...
        localArrayList.add(this.mWorkSpec.input);
        localArrayList.addAll(this.mWorkSpecDao.getInputsFromPrerequisites(this.mWorkSpecId));
      }
      localObject1 = new WorkerParameters(UUID.fromString(this.mWorkSpecId), (Data)localObject1, this.mTags, this.mRuntimeExtras, this.mWorkSpec.runAttemptCount, this.mConfiguration.getExecutor(), this.mWorkTaskExecutor, this.mConfiguration.getWorkerFactory(), new WorkProgressUpdater(this.mWorkDatabase, this.mWorkTaskExecutor), new WorkForegroundUpdater(this.mForegroundProcessor, this.mWorkTaskExecutor));
      if (this.mWorker == null) {
        this.mWorker = this.mConfiguration.getWorkerFactory().createWorkerWithDefaultFallback(this.mAppContext, this.mWorkSpec.workerClassName, (WorkerParameters)localObject1);
      }
      ...
      if (trySetRunning())
      {
        ...
        this.mWorkTaskExecutor.getMainThreadExecutor().execute(new Runnable()
        {
          ...
          {
            // Byte code:
            //   0: invokestatic 31	androidx/work/Logger:get	()Landroidx/work/Logger;
            //   3: getstatic 35	androidx/work/impl/WorkerWrapper:TAG	Ljava/lang/String;
            //   6: ldc 37
            //   8: iconst_1
            ...
            //   13: iconst_0
            //   14: aload_0
            //   15: getfield 19	androidx/work/impl/WorkerWrapper$1:this$0	Landroidx/work/impl/WorkerWrapper;
            //   18: getfield 41	androidx/work/impl/WorkerWrapper:mWorkSpec	Landroidx/work/impl/model/WorkSpec;
            //   21: getfield 46	androidx/work/impl/model/WorkSpec:workerClassName	Ljava/lang/String;
            //   24: aastore
            //   25: invokestatic 52	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
            //   28: iconst_0
            //   29: anewarray 54	java/lang/Throwable
            //   32: invokevirtual 58	androidx/work/Logger:debug	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
            //   35: aload_0
            //   36: getfield 19	androidx/work/impl/WorkerWrapper$1:this$0	Landroidx/work/impl/WorkerWrapper;
            //   39: aload_0
            //   40: getfield 19	androidx/work/impl/WorkerWrapper$1:this$0	Landroidx/work/impl/WorkerWrapper;
            //   43: getfield 62	androidx/work/impl/WorkerWrapper:mWorker	Landroidx/work/ListenableWorker;
            //   46: invokevirtual 68	androidx/work/ListenableWorker:startWork	()Lcom/google/common/util/concurrent/ListenableFuture;
            //   49: putfield 72	androidx/work/impl/WorkerWrapper:mInnerFuture	Lcom/google/common/util/concurrent/ListenableFuture;
            //   52: aload_0
            //   53: getfield 21	androidx/work/impl/WorkerWrapper$1:val$future	Landroidx/work/impl/utils/futures/SettableFuture;
            //   56: aload_0
            //   57: getfield 19	androidx/work/impl/WorkerWrapper$1:this$0	Landroidx/work/impl/WorkerWrapper;
            //   60: getfield 72	androidx/work/impl/WorkerWrapper:mInnerFuture	Lcom/google/common/util/concurrent/ListenableFuture;
            //   63: invokevirtual 78	androidx/work/impl/utils/futures/SettableFuture:setFuture	(Lcom/google/common/util/concurrent/ListenableFuture;)Z
            //   66: pop
            //   67: goto +13 -> 80
            //   70: astore_1
            //   71: aload_0
            //   72: getfield 21	androidx/work/impl/WorkerWrapper$1:val$future	Landroidx/work/impl/utils/futures/SettableFuture;
            //   75: aload_1
            //   76: invokevirtual 82	androidx/work/impl/utils/futures/SettableFuture:setException	(Ljava/lang/Throwable;)Z
            //   79: pop
            //   80: return
            // Local variable table:
            //   start	length	slot	name	signature
            //   0	81	0	this	1
            //   70	6	1	localThrowable	Throwable
            // Exception table:
            //   from	to	target	type
            //   0	67	70	finally
          }
