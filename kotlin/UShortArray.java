  ...
  implements Collection<UShort>, KMappedMarker
{
  ...
  public static int hashCode-impl(short[] paramArrayOfShort)
  {
    ...
    if (paramArrayOfShort != null) {
      i = Arrays.hashCode(paramArrayOfShort);
    } else {
      i = 0;
    }
    return i;
