  ...
  public void resume(Object paramObject)
  {
    ...
    try
    {
      ...
      if (paramObject != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
        ...
        {
          paramObject = new kotlin/TypeCastException;
          paramObject.<init>("null cannot be cast to non-null type kotlin.coroutines.experimental.Continuation<kotlin.Any?>");
          throw paramObject;
        }
      }
    }
  ...
  public void resumeWithException(Throwable paramThrowable)
  {
    ...
    try
    {
      ...
      if (paramThrowable != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
        ...
        {
          paramThrowable = new kotlin/TypeCastException;
          paramThrowable.<init>("null cannot be cast to non-null type kotlin.coroutines.experimental.Continuation<kotlin.Any?>");
