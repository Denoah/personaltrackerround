...
class IntrinsicsKt__IntrinsicsJvmKt
{
        ...
        try
        {
          ...
          if (localObject != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
            ...
            else
            {
              ...
              ((TypeCastException)localObject).<init>("null cannot be cast to non-null type kotlin.coroutines.experimental.Continuation<kotlin.Any?>");
  ...
  public static final <T> Continuation<Unit> createCoroutineUnchecked(final Function1<? super Continuation<? super T>, ? extends Object> paramFunction1, final Continuation<? super T> paramContinuation)
  {
    ...
    if (!(paramFunction1 instanceof CoroutineImpl))
    {
      paramFunction1 = new Continuation()
      {
        ...
        public void resume(Unit paramAnonymousUnit)
        {
          ...
          try
          {
            ...
            {
              localObject = new kotlin/TypeCastException;
              ((TypeCastException)localObject).<init>("null cannot be cast to non-null type (kotlin.coroutines.experimental.Continuation<T>) -> kotlin.Any?");
              throw ((Throwable)localObject);
            }
          }
          finally
      ...
      paramFunction1 = CoroutineIntrinsics.interceptContinuationIfNeeded(paramContinuation.getContext(), (Continuation)paramFunction1);
    }
    else
    {
      ...
      paramFunction1 = ((CoroutineImpl)paramFunction1).getFacade();
    }
  ...
  public static final <R, T> Continuation<Unit> createCoroutineUnchecked(final Function2<? super R, ? super Continuation<? super T>, ? extends Object> paramFunction2, final R paramR, final Continuation<? super T> paramContinuation)
  {
    ...
    if (!(paramFunction2 instanceof CoroutineImpl))
    {
      paramFunction2 = new Continuation()
      {
        ...
        public void resume(Unit paramAnonymousUnit)
        {
          ...
          try
          {
            ...
            {
              localObject = new kotlin/TypeCastException;
              ((TypeCastException)localObject).<init>("null cannot be cast to non-null type (R, kotlin.coroutines.experimental.Continuation<T>) -> kotlin.Any?");
              throw ((Throwable)localObject);
            }
          }
          finally
      ...
      paramFunction2 = CoroutineIntrinsics.interceptContinuationIfNeeded(paramContinuation.getContext(), (Continuation)paramFunction2);
    }
    else
    {
      ...
      paramFunction2 = ((CoroutineImpl)paramFunction2).getFacade();
    }
