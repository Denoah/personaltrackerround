...
public final class _Util
{
  ...
  public static final String toHexString(int paramInt)
  {
    ...
    arrayOfChar[1] = ((char)okio.internal.ByteStringKt.getHEX_DIGIT_CHARS()[(paramInt >> 24 & 0xF)]);
    arrayOfChar[2] = ((char)okio.internal.ByteStringKt.getHEX_DIGIT_CHARS()[(paramInt >> 20 & 0xF)]);
    arrayOfChar[3] = ((char)okio.internal.ByteStringKt.getHEX_DIGIT_CHARS()[(paramInt >> 16 & 0xF)]);
    arrayOfChar[4] = ((char)okio.internal.ByteStringKt.getHEX_DIGIT_CHARS()[(paramInt >> 12 & 0xF)]);
    arrayOfChar[5] = ((char)okio.internal.ByteStringKt.getHEX_DIGIT_CHARS()[(paramInt >> 8 & 0xF)]);
    arrayOfChar[6] = ((char)okio.internal.ByteStringKt.getHEX_DIGIT_CHARS()[(paramInt >> 4 & 0xF)]);
    arrayOfChar[7] = ((char)okio.internal.ByteStringKt.getHEX_DIGIT_CHARS()[(paramInt & 0xF)]);
    for (paramInt = j; (paramInt < 8) && (arrayOfChar[paramInt] == '0'); paramInt++) {}
  ...
  public static final String toHexString(long paramLong)
  {
    ...
    int j = 0;
    arrayOfChar[0] = ((char)i);
    arrayOfChar[1] = ((char)okio.internal.ByteStringKt.getHEX_DIGIT_CHARS()[((int)(paramLong >> 56 & 0xF))]);
    arrayOfChar[2] = ((char)okio.internal.ByteStringKt.getHEX_DIGIT_CHARS()[((int)(paramLong >> 52 & 0xF))]);
    arrayOfChar[3] = ((char)okio.internal.ByteStringKt.getHEX_DIGIT_CHARS()[((int)(paramLong >> 48 & 0xF))]);
    arrayOfChar[4] = ((char)okio.internal.ByteStringKt.getHEX_DIGIT_CHARS()[((int)(paramLong >> 44 & 0xF))]);
    arrayOfChar[5] = ((char)okio.internal.ByteStringKt.getHEX_DIGIT_CHARS()[((int)(paramLong >> 40 & 0xF))]);
    arrayOfChar[6] = ((char)okio.internal.ByteStringKt.getHEX_DIGIT_CHARS()[((int)(paramLong >> 36 & 0xF))]);
    arrayOfChar[7] = ((char)okio.internal.ByteStringKt.getHEX_DIGIT_CHARS()[((int)(paramLong >> 32 & 0xF))]);
    arrayOfChar[8] = ((char)okio.internal.ByteStringKt.getHEX_DIGIT_CHARS()[((int)(paramLong >> 28 & 0xF))]);
    arrayOfChar[9] = ((char)okio.internal.ByteStringKt.getHEX_DIGIT_CHARS()[((int)(paramLong >> 24 & 0xF))]);
    arrayOfChar[10] = ((char)okio.internal.ByteStringKt.getHEX_DIGIT_CHARS()[((int)(paramLong >> 20 & 0xF))]);
    arrayOfChar[11] = ((char)okio.internal.ByteStringKt.getHEX_DIGIT_CHARS()[((int)(paramLong >> 16 & 0xF))]);
    arrayOfChar[12] = ((char)okio.internal.ByteStringKt.getHEX_DIGIT_CHARS()[((int)(paramLong >> 12 & 0xF))]);
    arrayOfChar[13] = ((char)okio.internal.ByteStringKt.getHEX_DIGIT_CHARS()[((int)(paramLong >> 8 & 0xF))]);
    arrayOfChar[14] = ((char)okio.internal.ByteStringKt.getHEX_DIGIT_CHARS()[((int)(paramLong >> 4 & 0xF))]);
    arrayOfChar[15] = ((char)okio.internal.ByteStringKt.getHEX_DIGIT_CHARS()[((int)(paramLong & 0xF))]);
