...
public final class ConnectionSpec
{
  ...
  {
    Object localObject = this.cipherSuitesAsString;
    if (localObject != null)
    {
      ...
      localObject = CollectionsKt.toList((Iterable)localCollection);
    }
    else
    {
      localObject = null;
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if (bool != paramObject.isTls) {
      return false;
    }
    if (bool)
    {
      if (!Arrays.equals(this.cipherSuitesAsString, paramObject.cipherSuitesAsString)) {
        return false;
      }
      if (!Arrays.equals(this.tlsVersionsAsString, paramObject.tlsVersionsAsString)) {
        return false;
      }
  ...
  public int hashCode()
  {
    ...
    if (this.isTls)
    {
      ...
      j = ((527 + j) * 31 + i) * 31 + (this.supportsTlsExtensions ^ true);
    }
    else
    {
      j = 17;
  ...
  {
    Object localObject = this.tlsVersionsAsString;
    if (localObject != null)
    {
      Collection localCollection = (Collection)new ArrayList(localObject.length);
      int i = localObject.length;
  ...
  public static final class Builder
  {
    ...
    public final Builder cipherSuites(CipherSuite... paramVarArgs)
    {
      ...
      if (localBuilder.tls)
      {
        ...
        for (int j = 0; j < i; j++) {
          localCollection.add(paramVarArgs[j].javaName());
        }
