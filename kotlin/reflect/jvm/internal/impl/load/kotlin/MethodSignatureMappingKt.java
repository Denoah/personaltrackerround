...
{
  private static final void appendErasedType(StringBuilder paramStringBuilder, KotlinType paramKotlinType)
  {
    paramStringBuilder.append(mapToJvmType(paramKotlinType));
  }
  
  public static final String computeJvmDescriptor(FunctionDescriptor paramFunctionDescriptor, boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  public static final String computeJvmSignature(CallableDescriptor paramCallableDescriptor)
  {
    ...
    Object localObject1 = paramCallableDescriptor.getContainingDeclaration();
    ...
    {
      localObject2 = ((ClassDescriptor)localObject1).getName();
      Intrinsics.checkExpressionValueIsNotNull(localObject2, "classDescriptor.name");
      if (((Name)localObject2).isSpecial()) {
        return null;
      }
      localObject2 = paramCallableDescriptor.getOriginal();
      paramCallableDescriptor = (CallableDescriptor)localObject2;
      ...
      if (paramCallableDescriptor != null) {
        return localSignatureBuildingComponents.signature((ClassDescriptor)localObject1, computeJvmDescriptor$default((FunctionDescriptor)paramCallableDescriptor, false, false, 3, null));
      }
    }
    return null;
  }
  
  public static final boolean forceSingleValueParameterBoxing(CallableDescriptor paramCallableDescriptor)
  {
  ...
  public static final String getInternalName(ClassDescriptor paramClassDescriptor)
  {
  ...
  public static final JvmType mapToJvmType(KotlinType paramKotlinType)
  {
