  ...
  extends WorkContinuation
{
  ...
  WorkContinuationImpl(WorkManagerImpl paramWorkManagerImpl, String paramString, ExistingWorkPolicy paramExistingWorkPolicy, List<? extends WorkRequest> paramList)
  {
    this(paramWorkManagerImpl, paramString, paramExistingWorkPolicy, paramList, null);
  }
  
  WorkContinuationImpl(WorkManagerImpl paramWorkManagerImpl, String paramString, ExistingWorkPolicy paramExistingWorkPolicy, List<? extends WorkRequest> paramList, List<WorkContinuationImpl> paramList1)
  {
  ...
  WorkContinuationImpl(WorkManagerImpl paramWorkManagerImpl, List<? extends WorkRequest> paramList)
  {
