...
public final class Handshake
{
  ...
  public boolean equals(Object paramObject)
  {
    if ((paramObject instanceof Handshake))
    {
      ...
      if ((paramObject.tlsVersion == this.tlsVersion) && (Intrinsics.areEqual(paramObject.cipherSuite, this.cipherSuite)) && (Intrinsics.areEqual(paramObject.peerCertificates(), peerCertificates())) && (Intrinsics.areEqual(paramObject.localCertificates, this.localCertificates))) {
        return true;
      }
    }
    boolean bool = false;
  ...
  public String toString()
  {
    try
    {
      Object localObject1 = (Iterable)peerCertificates();
      ...
      while (((Iterator)localObject1).hasNext()) {
        ((Collection)localObject3).add(getName((Certificate)((Iterator)localObject1).next()));
      }
      localObject1 = ((List)localObject3).toString();
    }
    catch (SSLPeerUnverifiedException localSSLPeerUnverifiedException)
    {
      localObject2 = "Failed: SSLPeerUnverifiedException";
    }
    Object localObject3 = new StringBuilder();
    ((StringBuilder)localObject3).append("Handshake{");
    ((StringBuilder)localObject3).append("tlsVersion=");
    ((StringBuilder)localObject3).append(this.tlsVersion);
    ((StringBuilder)localObject3).append(' ');
    ((StringBuilder)localObject3).append("cipherSuite=");
    ((StringBuilder)localObject3).append(this.cipherSuite);
    ((StringBuilder)localObject3).append(' ');
    ((StringBuilder)localObject3).append("peerCertificates=");
    ((StringBuilder)localObject3).append((String)localObject2);
    ((StringBuilder)localObject3).append(' ');
    ((StringBuilder)localObject3).append("localCertificates=");
    Object localObject4 = (Iterable)this.localCertificates;
    Object localObject2 = (Collection)new ArrayList(CollectionsKt.collectionSizeOrDefault((Iterable)localObject4, 10));
    localObject4 = ((Iterable)localObject4).iterator();
    while (((Iterator)localObject4).hasNext()) {
      ((Collection)localObject2).add(getName((Certificate)((Iterator)localObject4).next()));
    }
    ((StringBuilder)localObject3).append((List)localObject2);
    ((StringBuilder)localObject3).append('}');
  ...
  public static final class Companion
  {
      ...
      throws IOException
    {
      ...
      if (localObject != null)
      {
        ...
        paramSSLSession.append(localList);
