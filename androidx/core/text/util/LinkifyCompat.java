...
public final class LinkifyCompat
{
  ...
  private static void pruneOverlaps(ArrayList<LinkSpec> paramArrayList, Spannable paramSpannable)
  {
    ...
    while (i < k - 1)
    {
      localObject2 = (LinkSpec)paramArrayList.get(i);
      int m = i + 1;
      localObject1 = (LinkSpec)paramArrayList.get(m);
      if ((((LinkSpec)localObject2).start <= ((LinkSpec)localObject1).start) && (((LinkSpec)localObject2).end > ((LinkSpec)localObject1).start))
      {
        ...
        while (((LinkSpec)localObject2).end - ((LinkSpec)localObject2).start > ((LinkSpec)localObject1).end - ((LinkSpec)localObject1).start)
        {
          j = m;
          break;
        }
