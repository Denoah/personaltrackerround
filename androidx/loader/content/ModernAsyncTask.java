...
abstract class ModernAsyncTask<Params, Progress, Result>
{
  ...
  private final WorkerRunnable<Params, Result> mWorker = new WorkerRunnable()
  {
      ...
      throws Exception
    {
      ...
      finally
      {
        ...
        {
          ModernAsyncTask.this.postResult(localObject4);
        }
      }
    }
  };
  ...
  static
  {
    ...
    sDefaultExecutor = localThreadPoolExecutor;
  }
  ...
  public static enum Status
  {
    static
    {
      Status localStatus = new Status("FINISHED", 2);
      FINISHED = localStatus;
      $VALUES = new Status[] { PENDING, RUNNING, localStatus };
    }
