  ...
  extends Platform
{
  ...
  {
    Object localObject = (Iterable)CollectionsKt.listOfNotNull(new SocketAdapter[] { Android10SocketAdapter.Companion.buildIfSupported(), ConscryptSocketAdapter.Companion.buildIfSupported(), (SocketAdapter)new DeferredSocketAdapter("com.google.android.gms.org.conscrypt") });
  ...
  public CertificateChainCleaner buildCertificateChainCleaner(X509TrustManager paramX509TrustManager)
  {
    ...
    if (localAndroid10CertificateChainCleaner != null) {
      paramX509TrustManager = (CertificateChainCleaner)localAndroid10CertificateChainCleaner;
    } else {
