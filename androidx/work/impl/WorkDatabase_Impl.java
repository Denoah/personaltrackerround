  ...
  extends WorkDatabase
{
  ...
  {
    Object localObject = new RoomOpenHelper(paramDatabaseConfiguration, new RoomOpenHelper.Delegate(10)
    {
      public void createAllTables(SupportSQLiteDatabase paramAnonymousSupportSQLiteDatabase)
      {
        ...
        paramAnonymousSupportSQLiteDatabase.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'cf029002fffdcadf079e8d0a1c9a70ac')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase paramAnonymousSupportSQLiteDatabase)
      {
        ...
        localHashSet.add(new TableInfo.ForeignKey("WorkSpec", "CASCADE", "CASCADE", Arrays.asList(new String[] { "work_spec_id" }), Arrays.asList(new String[] { "id" })));
        localHashSet.add(new TableInfo.ForeignKey("WorkSpec", "CASCADE", "CASCADE", Arrays.asList(new String[] { "prerequisite_id" }), Arrays.asList(new String[] { "id" })));
        ...
        localObject2 = new TableInfo("Dependency", (Map)localObject1, localHashSet, (Set)localObject2);
        ...
        localObject1 = new HashMap(24);
        ((HashMap)localObject1).put("id", new TableInfo.Column("id", "TEXT", true, 1, null, 1));
        ((HashMap)localObject1).put("state", new TableInfo.Column("state", "INTEGER", true, 0, null, 1));
        ((HashMap)localObject1).put("worker_class_name", new TableInfo.Column("worker_class_name", "TEXT", true, 0, null, 1));
        ((HashMap)localObject1).put("input_merger_class_name", new TableInfo.Column("input_merger_class_name", "TEXT", false, 0, null, 1));
        ((HashMap)localObject1).put("input", new TableInfo.Column("input", "BLOB", true, 0, null, 1));
        ((HashMap)localObject1).put("output", new TableInfo.Column("output", "BLOB", true, 0, null, 1));
        ((HashMap)localObject1).put("initial_delay", new TableInfo.Column("initial_delay", "INTEGER", true, 0, null, 1));
        ((HashMap)localObject1).put("interval_duration", new TableInfo.Column("interval_duration", "INTEGER", true, 0, null, 1));
        ((HashMap)localObject1).put("flex_duration", new TableInfo.Column("flex_duration", "INTEGER", true, 0, null, 1));
        ((HashMap)localObject1).put("run_attempt_count", new TableInfo.Column("run_attempt_count", "INTEGER", true, 0, null, 1));
        ((HashMap)localObject1).put("backoff_policy", new TableInfo.Column("backoff_policy", "INTEGER", true, 0, null, 1));
        ((HashMap)localObject1).put("backoff_delay_duration", new TableInfo.Column("backoff_delay_duration", "INTEGER", true, 0, null, 1));
        ((HashMap)localObject1).put("period_start_time", new TableInfo.Column("period_start_time", "INTEGER", true, 0, null, 1));
        ((HashMap)localObject1).put("minimum_retention_duration", new TableInfo.Column("minimum_retention_duration", "INTEGER", true, 0, null, 1));
        ((HashMap)localObject1).put("schedule_requested_at", new TableInfo.Column("schedule_requested_at", "INTEGER", true, 0, null, 1));
        ((HashMap)localObject1).put("run_in_foreground", new TableInfo.Column("run_in_foreground", "INTEGER", true, 0, null, 1));
        ((HashMap)localObject1).put("required_network_type", new TableInfo.Column("required_network_type", "INTEGER", false, 0, null, 1));
        ((HashMap)localObject1).put("requires_charging", new TableInfo.Column("requires_charging", "INTEGER", true, 0, null, 1));
        ((HashMap)localObject1).put("requires_device_idle", new TableInfo.Column("requires_device_idle", "INTEGER", true, 0, null, 1));
        ((HashMap)localObject1).put("requires_battery_not_low", new TableInfo.Column("requires_battery_not_low", "INTEGER", true, 0, null, 1));
        ((HashMap)localObject1).put("requires_storage_not_low", new TableInfo.Column("requires_storage_not_low", "INTEGER", true, 0, null, 1));
        ((HashMap)localObject1).put("trigger_content_update_delay", new TableInfo.Column("trigger_content_update_delay", "INTEGER", true, 0, null, 1));
        ((HashMap)localObject1).put("trigger_max_content_delay", new TableInfo.Column("trigger_max_content_delay", "INTEGER", true, 0, null, 1));
        ((HashMap)localObject1).put("content_uri_triggers", new TableInfo.Column("content_uri_triggers", "BLOB", false, 0, null, 1));
        localObject2 = new HashSet(0);
        localHashSet = new HashSet(2);
        localHashSet.add(new TableInfo.Index("index_WorkSpec_schedule_requested_at", false, Arrays.asList(new String[] { "schedule_requested_at" })));
        localHashSet.add(new TableInfo.Index("index_WorkSpec_period_start_time", false, Arrays.asList(new String[] { "period_start_time" })));
        localObject2 = new TableInfo("WorkSpec", (Map)localObject1, (Set)localObject2, localHashSet);
        ...
        localHashSet.add(new TableInfo.Index("index_WorkTag_work_spec_id", false, Arrays.asList(new String[] { "work_spec_id" })));
        localObject1 = new TableInfo("WorkTag", (Map)localObject1, (Set)localObject2, localHashSet);
        localObject2 = TableInfo.read(paramAnonymousSupportSQLiteDatabase, "WorkTag");
        ...
        localObject2 = new TableInfo("SystemIdInfo", (Map)localObject2, (Set)localObject1, new HashSet(0));
        ...
        localObject1 = new HashMap(2);
        ((HashMap)localObject1).put("name", new TableInfo.Column("name", "TEXT", true, 1, null, 1));
        ((HashMap)localObject1).put("work_spec_id", new TableInfo.Column("work_spec_id", "TEXT", true, 2, null, 1));
        localHashSet = new HashSet(1);
        localHashSet.add(new TableInfo.ForeignKey("WorkSpec", "CASCADE", "CASCADE", Arrays.asList(new String[] { "work_spec_id" }), Arrays.asList(new String[] { "id" })));
        localObject2 = new HashSet(1);
        ((HashSet)localObject2).add(new TableInfo.Index("index_WorkName_work_spec_id", false, Arrays.asList(new String[] { "work_spec_id" })));
        localObject1 = new TableInfo("WorkName", (Map)localObject1, localHashSet, (Set)localObject2);
        ...
        localObject2 = new HashMap(2);
        ((HashMap)localObject2).put("key", new TableInfo.Column("key", "TEXT", true, 1, null, 1));
        ((HashMap)localObject2).put("long_value", new TableInfo.Column("long_value", "INTEGER", false, 0, null, 1));
        localObject2 = new TableInfo("Preference", (Map)localObject2, new HashSet(0), new HashSet(0));
        paramAnonymousSupportSQLiteDatabase = TableInfo.read(paramAnonymousSupportSQLiteDatabase, "Preference");
        if (!((TableInfo)localObject2).equals(paramAnonymousSupportSQLiteDatabase))
        {
          localObject1 = new StringBuilder();
          ((StringBuilder)localObject1).append("Preference(androidx.work.impl.model.Preference).\n Expected:\n");
          ((StringBuilder)localObject1).append(localObject2);
          ((StringBuilder)localObject1).append("\n Found:\n");
          ((StringBuilder)localObject1).append(paramAnonymousSupportSQLiteDatabase);
          return new RoomOpenHelper.ValidationResult(false, ((StringBuilder)localObject1).toString());
        }
