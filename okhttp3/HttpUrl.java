...
public final class HttpUrl
{
  ...
  {
    Object localObject1 = newBuilder().reencodeForUri$okhttp().toString();
    Object localObject2;
    try
    {
    ...
    try
    {
      ...
      ((Regex)localObject1).<init>("[\\u0000-\\u001F\\u007F-\\u009F\\p{javaWhitespace}]");
      localObject2 = URI.create(((Regex)localObject1).replace((CharSequence)localObject2, ""));
      Intrinsics.checkExpressionValueIsNotNull(localObject2, "URI.create(stripped)");
      return localObject2;
    }
  ...
  public static final class Builder
  {
    ...
    {
      boolean bool1 = Intrinsics.areEqual(paramString, ".");
      boolean bool2 = true;
      boolean bool3 = bool2;
      if (!bool1) {
    ...
    public final HttpUrl build()
    {
      ...
      if (str1 != null)
      {
        ...
        String str3 = HttpUrl.Companion.percentDecode$okhttp$default(HttpUrl.Companion, this.encodedPassword, 0, 0, false, 7, null);
        String str4 = this.host;
        if (str4 != null)
        {
          int i = effectivePort();
          List localList1 = HttpUrl.Companion.percentDecode$default(HttpUrl.Companion, this.encodedPathSegments, false, 1, null);
          if (localList1 != null)
          {
            List localList2 = this.encodedQueryNamesAndValues;
            if (localList2 != null) {
              localList2 = HttpUrl.Companion.access$percentDecode(HttpUrl.Companion, localList2, true);
            } else {
              localList2 = null;
            }
            String str5 = this.encodedFragment;
            if (str5 != null) {
              str5 = HttpUrl.Companion.percentDecode$okhttp$default(HttpUrl.Companion, str5, 0, 0, false, 7, null);
            } else {
              str5 = null;
            }
            return new HttpUrl(str1, str2, str3, str4, i, localList1, localList2, str5, toString());
          }
    ...
    public final Builder host(String paramString)
    {
      ...
      Builder localBuilder = (Builder)this;
      Object localObject = HostnamesKt.toCanonicalHost(HttpUrl.Companion.percentDecode$okhttp$default(HttpUrl.Companion, paramString, 0, 0, false, 7, null));
      if (localObject != null)
      {
        localBuilder.host = ((String)localObject);
        return localBuilder;
      }
      localObject = new StringBuilder();
    ...
    public final Builder parse$okhttp(HttpUrl paramHttpUrl, String paramString)
    {
      ...
      else
      {
        ...
        for (;;)
        {
          i2 = Util.delimiterOffset(paramString, "@/\\?#", n, j);
          if (i2 != j) {
            m = paramString.charAt(i2);
          } else {
            m = -1;
          }
          if ((m == -1) || (m == 35) || (m == 47) || (m == 92) || (m == 63)) {
            break;
          }
          if (m == 64)
          {
            if (k == 0)
            {
              int i3 = Util.delimiterOffset(paramString, ':', n, i2);
              localObject1 = HttpUrl.Companion;
              m = i;
              localObject2 = HttpUrl.Companion.canonicalize$okhttp$default((HttpUrl.Companion)localObject1, paramString, n, i3, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, 240, null);
              ...
              if (i3 != i2)
              {
                this.encodedPassword = HttpUrl.Companion.canonicalize$okhttp$default(HttpUrl.Companion, paramString, i3 + 1, i2, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, 240, null);
                k = m;
              }
              i1 = m;
            }
            else
            {
              ...
              ((StringBuilder)localObject1).append("%40");
              ((StringBuilder)localObject1).append(HttpUrl.Companion.canonicalize$okhttp$default(HttpUrl.Companion, paramString, n, i2, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, 240, null));
              this.encodedPassword = ((StringBuilder)localObject1).toString();
            }
            n = i2 + 1;
          }
        }
        i1 = Companion.access$portColonOffset(Companion, paramString, n, i2);
        m = i1 + 1;
        if (m < i2)
        {
          this.host = HostnamesKt.toCanonicalHost(HttpUrl.Companion.percentDecode$okhttp$default(HttpUrl.Companion, paramString, n, i1, false, 4, null));
          k = Companion.access$parsePort(Companion, paramString, m, i2);
          this.port = k;
          if (k != -1) {
            k = i;
          } else {
          ...
          {
            localObject1 = new StringBuilder();
            ((StringBuilder)localObject1).append("Invalid URL port: \"");
            paramString = paramString.substring(m, i2);
      ...
      label989:
      localObject1 = new StringBuilder();
      ((StringBuilder)localObject1).append("Invalid URL host: \"");
    ...
    public final Builder reencodeForUri$okhttp()
    {
      ...
      int i = localBuilder.encodedPathSegments.size();
      int j = 0;
      for (int k = 0; k < i; k++) {
        localBuilder.encodedPathSegments.set(k, HttpUrl.Companion.canonicalize$okhttp$default(HttpUrl.Companion, (String)localBuilder.encodedPathSegments.get(k), 0, 0, "[]", true, true, false, false, null, 227, null));
      }
      ...
      if (localObject3 != null)
      {
        ...
        for (k = j; k < i; k++)
        {
          localObject1 = (String)((List)localObject3).get(k);
          if (localObject1 != null) {
    ...
    public final Builder setEncodedPathSegment(int paramInt, String paramString)
    {
      Intrinsics.checkParameterIsNotNull(paramString, "encodedPathSegment");
      Builder localBuilder = (Builder)this;
      Object localObject = HttpUrl.Companion.canonicalize$okhttp$default(HttpUrl.Companion, paramString, 0, 0, " \"<>^`{}|/\\?#", true, false, false, false, null, 243, null);
    ...
    public static final class Companion
    {
      ...
      private final int schemeDelimiterOffset(String paramString, int paramInt1, int paramInt2)
      {
        ...
        for (;;)
        {
          ...
          if (((97 > j) || (122 < j)) && ((65 > j) || (90 < j)) && ((48 > j) || (57 < j)) && (j != 43) && (j != 45) && (j != 46)) {
            break;
          }
          k = paramInt1;
        }
  ...
  public static final class Companion
  {
    ...
    private final boolean isPercentEncoded(String paramString, int paramInt1, int paramInt2)
    {
      int i = paramInt1 + 2;
      boolean bool = true;
      if ((i >= paramInt2) || (paramString.charAt(paramInt1) != '%') || (Util.parseHexDigit(paramString.charAt(paramInt1 + 1)) == -1) || (Util.parseHexDigit(paramString.charAt(i)) == -1)) {
        bool = false;
      }
      return bool;
    }
        ...
        if (paramString1 != null)
        {
          ...
          else
          {
            ...
            if ((i == 43) && (paramBoolean3))
            {
              ...
              paramBuffer.writeUtf8((String)localObject3);
              localObject2 = localObject1;
            }
            ...
            else
            {
              ...
              if ((paramCharset != null) && (!Intrinsics.areEqual(paramCharset, StandardCharsets.UTF_8))) {
                ((Buffer)localObject3).writeString(paramString1, paramInt1, Character.charCount(i) + paramInt1, paramCharset);
              } else {
                ((Buffer)localObject3).writeUtf8CodePoint(i);
              }
              for (;;)
              {
                ...
                int j = ((Buffer)localObject3).readByte() & 0xFF;
    ...
    public final List<String> toQueryNamesAndValues$okhttp(String paramString)
    {
      ...
      for (int i = 0; i <= paramString.length(); i = k + 1)
      {
        ...
        int j = StringsKt.indexOf$default((CharSequence)localObject, '&', i, false, 4, null);
        k = j;
        if (j == -1) {
          k = paramString.length();
        }
        j = StringsKt.indexOf$default((CharSequence)localObject, '=', i, false, 4, null);
        if ((j != -1) && (j <= k))
        {
