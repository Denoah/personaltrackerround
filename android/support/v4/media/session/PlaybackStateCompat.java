  ...
  implements Parcelable
{
  ...
  public static PlaybackStateCompat fromPlaybackState(Object paramObject)
  {
    ...
    if (paramObject != null)
    {
      ...
      {
        localObject1 = PlaybackStateCompatApi21.getCustomActions(paramObject);
        if (localObject1 != null)
        {
          localObject2 = new ArrayList(((List)localObject1).size());
          localObject1 = ((List)localObject1).iterator();
          while (((Iterator)localObject1).hasNext()) {
            ((List)localObject2).add(CustomAction.fromCustomAction(((Iterator)localObject1).next()));
          }
        }
        else
        {
        ...
        localObject2 = new PlaybackStateCompat(PlaybackStateCompatApi21.getState(paramObject), PlaybackStateCompatApi21.getPosition(paramObject), PlaybackStateCompatApi21.getBufferedPosition(paramObject), PlaybackStateCompatApi21.getPlaybackSpeed(paramObject), PlaybackStateCompatApi21.getActions(paramObject), 0, PlaybackStateCompatApi21.getErrorMessage(paramObject), PlaybackStateCompatApi21.getLastPositionUpdateTime(paramObject), (List)localObject2, PlaybackStateCompatApi21.getActiveQueueItemId(paramObject), localBundle);
        ((PlaybackStateCompat)localObject2).mStateObj = paramObject;
      }
    }
    return localObject2;
  }
    ...
    implements Parcelable
  {
    ...
    public Object getCustomAction()
    {
      ...
      {
        Object localObject = PlaybackStateCompatApi21.CustomAction.newInstance(this.mAction, this.mName, this.mIcon, this.mExtras);
        this.mCustomActionObj = localObject;
        return localObject;
      }
