...
class FindAddress
{
  ...
  private static final Pattern sWordRe = Pattern.compile("[^,*表t ???????????????\n\013\f\r???]+(?=[,*表t ???????????????\n\013\f\r???]|$)", 2);
  private static final Pattern sZipCodeRe = Pattern.compile("(?:[0-9]{5}(?:-[0-9]{4})?)(?=[,*表t ???????????????\n\013\f\r???]|$)", 2);
  
  static
  {
    sHouseNumberRe = Pattern.compile("(?:one|[0-9]+([a-z](?=[^a-z]|$)|st|nd|rd|th)?)(?:-(?:one|[0-9]+([a-z](?=[^a-z]|$)|st|nd|rd|th)?))*(?=[,\"'\t ???????????????\n\013\f\r???]|$)", 2);
    sStateRe = Pattern.compile("(?:(ak|alaska)|(al|alabama)|(ar|arkansas)|(as|american[\t ???????????????]+samoa)|(az|arizona)|(ca|california)|(co|colorado)|(ct|connecticut)|(dc|district[\t ???????????????]+of[\t ???????????????]+columbia)|(de|delaware)|(fl|florida)|(fm|federated[\t ???????????????]+states[\t ???????????????]+of[\t ???????????????]+micronesia)|(ga|georgia)|(gu|guam)|(hi|hawaii)|(ia|iowa)|(id|idaho)|(il|illinois)|(in|indiana)|(ks|kansas)|(ky|kentucky)|(la|louisiana)|(ma|massachusetts)|(md|maryland)|(me|maine)|(mh|marshall[\t ???????????????]+islands)|(mi|michigan)|(mn|minnesota)|(mo|missouri)|(mp|northern[\t ???????????????]+mariana[\t ???????????????]+islands)|(ms|mississippi)|(mt|montana)|(nc|north[\t ???????????????]+carolina)|(nd|north[\t ???????????????]+dakota)|(ne|nebraska)|(nh|new[\t ???????????????]+hampshire)|(nj|new[\t ???????????????]+jersey)|(nm|new[\t ???????????????]+mexico)|(nv|nevada)|(ny|new[\t ???????????????]+york)|(oh|ohio)|(ok|oklahoma)|(or|oregon)|(pa|pennsylvania)|(pr|puerto[\t ???????????????]+rico)|(pw|palau)|(ri|rhode[\t ???????????????]+island)|(sc|south[\t ???????????????]+carolina)|(sd|south[\t ???????????????]+dakota)|(tn|tennessee)|(tx|texas)|(ut|utah)|(va|virginia)|(vi|virgin[\t ???????????????]+islands)|(vt|vermont)|(wa|washington)|(wi|wisconsin)|(wv|west[\t ???????????????]+virginia)|(wy|wyoming))(?=[,*表t ???????????????\n\013\f\r???]|$)", 2);
  }
