...
public enum BlendModeCompat
{
  static
  {
    ...
    BlendModeCompat localBlendModeCompat = new BlendModeCompat("LUMINOSITY", 28);
    LUMINOSITY = localBlendModeCompat;
    $VALUES = new BlendModeCompat[] { CLEAR, SRC, DST, SRC_OVER, DST_OVER, SRC_IN, DST_IN, SRC_OUT, DST_OUT, SRC_ATOP, DST_ATOP, XOR, PLUS, MODULATE, SCREEN, OVERLAY, DARKEN, LIGHTEN, COLOR_DODGE, COLOR_BURN, HARD_LIGHT, SOFT_LIGHT, DIFFERENCE, EXCLUSION, MULTIPLY, HUE, SATURATION, COLOR, localBlendModeCompat };
  }
  
  private BlendModeCompat() {}
}
