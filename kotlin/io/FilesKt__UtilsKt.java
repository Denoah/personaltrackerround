  ...
  extends FilesKt__FileTreeWalkKt
{
  ...
  public static final boolean copyRecursively(File paramFile1, File paramFile2, boolean paramBoolean, Function2<? super File, ? super IOException, ? extends OnErrorAction> paramFunction2)
  {
    ...
    try
    {
      Object localObject1 = FilesKt.walkTopDown(paramFile1);
      Object localObject2 = new kotlin/io/FilesKt__UtilsKt$copyRecursively$2;
      ((copyRecursively.2)localObject2).<init>(paramFunction2);
      localObject2 = ((FileTreeWalk)localObject1).onFail((Function2)localObject2).iterator();
      while (((Iterator)localObject2).hasNext())
      {
        ...
        if (!((File)localObject1).exists())
        {
          ...
          ((NoSuchFileException)localObject3).<init>((File)localObject1, null, "The source file doesn't exist.", 2, null);
          if ((OnErrorAction)paramFunction2.invoke(localObject1, localObject3) == OnErrorAction.TERMINATE) {
            return false;
          }
        }
        else
        {
          Object localObject4 = FilesKt.toRelativeString((File)localObject1, paramFile1);
          localObject3 = new java/io/File;
          ((File)localObject3).<init>(paramFile2, (String)localObject4);
          if ((((File)localObject3).exists()) && ((!((File)localObject1).isDirectory()) || (!((File)localObject3).isDirectory())))
          {
            if (!paramBoolean) {}
            while (((File)localObject3).isDirectory() ? !FilesKt.deleteRecursively((File)localObject3) : !((File)localObject3).delete())
            {
              i = 1;
              break;
            }
            ...
            if (i != 0)
            {
              ...
              ((FileAlreadyExistsException)localObject4).<init>((File)localObject1, (File)localObject3, "The destination file already exists.");
              if ((OnErrorAction)paramFunction2.invoke(localObject3, localObject4) != OnErrorAction.TERMINATE) {
                continue;
              }
              return false;
            }
          ...
          else if (FilesKt.copyTo$default((File)localObject1, (File)localObject3, paramBoolean, 0, 4, null).length() != ((File)localObject1).length())
          {
            ...
            localObject1 = (OnErrorAction)paramFunction2.invoke(localObject1, localObject3);
            localObject3 = OnErrorAction.TERMINATE;
  ...
  public static final File copyTo(File paramFile1, File paramFile2, boolean paramBoolean, int paramInt)
  {
    ...
    if (paramFile1.exists())
    {
      ...
      else
      {
        ...
        localThrowable1 = (Throwable)null;
      }
      try
      {
  ...
  public static final boolean deleteRecursively(File paramFile)
  {
    ...
    Iterator localIterator = ((Sequence)FilesKt.walkBottomUp(paramFile)).iterator();
  ...
  public static final File resolve(File paramFile1, File paramFile2)
  {
    ...
    if ((i == 0) && (!StringsKt.endsWith$default((CharSequence)localObject, File.separatorChar, false, 2, null)))
    {
      ...
      paramFile1 = new File(((StringBuilder)localObject).toString());
    }
    else
    {
      localObject = new StringBuilder();
  ...
  public static final boolean startsWith(File paramFile1, File paramFile2)
  {
    ...
    boolean bool1 = Intrinsics.areEqual(paramFile1.getRoot(), paramFile2.getRoot());
    boolean bool2 = false;
    if ((bool1 ^ true)) {
      return false;
    }
    if (paramFile1.getSize() >= paramFile2.getSize()) {
      bool2 = paramFile1.getSegments().subList(0, paramFile2.getSize()).equals(paramFile2.getSegments());
    }
    return bool2;
  }
  ...
  private static final String toRelativeStringOrNull$FilesKt__UtilsKt(File paramFile1, File paramFile2)
  {
    ...
    int i = paramFile2.getSize();
    int j = ((FilePathComponents)localObject).getSize();
    int k = 0;
    int m = Math.min(j, i);
    while ((k < m) && (Intrinsics.areEqual((File)((FilePathComponents)localObject).getSegments().get(k), (File)paramFile2.getSegments().get(k)))) {
      k++;
    }
    ...
    if (m >= k) {
      for (;;)
      {
        if (Intrinsics.areEqual(((File)paramFile2.getSegments().get(m)).getName(), "..")) {
          return null;
        }
        paramFile1.append("..");
        if (m != k) {
    ...
    if (k < j)
    {
      ...
      paramFile2 = (Iterable)CollectionsKt.drop((Iterable)((FilePathComponents)localObject).getSegments(), k);
